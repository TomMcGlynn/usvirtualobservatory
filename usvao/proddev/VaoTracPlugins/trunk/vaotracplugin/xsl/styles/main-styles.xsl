...
<xsl:template name="mainstyles">
    ...
    <xsl:if test="count(//office:styles/style:style[@style:name = 'Definition_20_Item']) = 0">
        <style:style style:display-name="Definition Item" 
                     style:family="paragraph" style:name="Definition_20_Item" 
                     style:next-style-name="Definition" style:parent-style-name="Text_20_body">
            <style:paragraph-properties fo:margin-bottom="0.0402in" fo:margin-top="0in"/>
            <style:text-properties fo:font-weight="bold" style:font-size-asian="10.5pt"/>
        </style:style>
    </xsl:if>

    <xsl:if test="count(//office:styles/style:style[@style:name = 'Definition']) = 0">
        <style:style style:family="paragraph" style:name="Definition" style:next-style-name="Definition_20_Item" style:parent-style-name="Text_20_body">
