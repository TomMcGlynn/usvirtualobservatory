...
<xsl:template match="h:dt">
    <text:p text:style-name="Definition_20_Item"><xsl:apply-templates select="child::node()" mode="inparagraph"/></text:p>
</xsl:template>

<xsl:template match="h:dd" mode="inparagraph"/>
<xsl:template match="h:dd">
    <text:p text:style-name="Definition"><xsl:apply-templates select="child::node()" mode="inparagraph"/></text:p>
</xsl:template>
