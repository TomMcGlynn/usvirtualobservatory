...
function dologout() {
    jQuery.get("/openid/logout", function(data) { 
...
<tr>
  ...
  <td align="left" valign="top" rowspan="3">
    <h1>
    Create A VAO Login <% if (fromAPortal) { %>for <%=HtmlEncode.encode(inps.getPortalName())%> <% } %>
    </h1>
  </td>
</tr>
</table>
...
<p>
You are about to create your own <a href="/" onclick="popupHelp('/help/GoodPasswords.html'); return false">VAO Login</a>&#8212;a
single unique identity which you can use to log onto any VAO-compliant
portal.  Creating a VAO Login is not required to use most VAO 
services; however, a VAO Login will give you access to enhanced
...
If this is your login, there's no need to proceed<%
 if (inps.getPortalName().length() > 0) {
 %>; use your back
...
<dl>
<dt>Creating a VAO Login is a two step process. <p>
...
<hr>
<center>
<p style="font-size: 75%; margin-left: 11px;">
This page is served from  
<b>sso.usvao.org</b>, 
<a href="/help/faq.html#phish">verified by Internet2/InCommon</a>
</p>
</center>
