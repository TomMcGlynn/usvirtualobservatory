...
class SCSService(dalquery.DALService):
    """
    ...
    def __init__(self, baseurl, resmeta=None, version="1.0"):
        ...
        :param resmeta:  An optional dictionary of properties about the 
                         service
        """
        dalquery.DALService.__init__(self, baseurl, "scs", version, resmeta)
...
class SCSQuery(dalquery.DALQuery):
    """
    ...
    def __init__(self, baseurl, version="1.0"):
        ...
        """
        dalquery.DALQuery.__init__(self, baseurl, "scs", version)
...
class SCSResults(dalquery.DALResults):
    """
    ...
    def __init__(self, votable, url=None, version="1.0"):
        ...
        """
        dalquery.DALResults.__init__(self, votable, url, "scs", version)
...
class SCSRecord(dalquery.Record):
    """
