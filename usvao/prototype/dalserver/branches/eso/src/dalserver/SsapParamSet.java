 ...
 * 
 * @version	1.0, 3-Dec-2006
 * @author	Doug Tody
 */
public class SsapParamSet extends ParamSet implements Iterable {

    /** Create an initial default SSAP parameter set. */
    public SsapParamSet() throws DalServerException, InvalidDateException {
	...
	this.addParam(new Param("VERSION",     STR, "1.0", "SSAP protocol version"));
	...
	this.addParam(new Param("SNR",         RFO, "Signal to noise ratio range"));
	...
	this.addParam(new Param("Token",       STR, "Continuation token for large queries"));
	this.addParam(new Param("Mtime",       RDO, "Range of modification times"));
	this.addParam(new Param("Compress",    BOO, "Allow protocol level compression"));
