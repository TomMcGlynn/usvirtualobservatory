...
public class DateParser
{
    ...
    throws InvalidDateException
    {
        ...
        // set non-lenient mode, so a brief checking of calendar fields is performed
        // out of range fields are not allowed
    ...
    throws InvalidDateException
    {
        // if the non-lenient mode an invalidDateException will be thrown if the ISO date is invalid
        // (if any calendar fields have out-of-range values)
        try
        {
