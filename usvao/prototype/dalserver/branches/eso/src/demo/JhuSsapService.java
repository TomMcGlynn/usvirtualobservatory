...
public class JhuSsapService extends SsapService {
    ...
    private static final String queryUrlCone = "http://voserrvices.net" +
     ...
     */
    public JhuSsapService(SsapParamSet params) {
        super(params);
    }
    ...
    throws DalServerException {
        ...
        if (format != null && format.equalsIgnoreCase("native")) {
            ...
            contentType = "text/xml;x-votable";
        ...
        try {
            ...
            throw new DalServerException("getData: can't happen");
        }
...
// ------------- Internal Methods ----------------
    ...
    throws DalServerException {
        ...
        if ((p = params.getParam("FluxCalib")) != null && p.isSet()) {
            urlParams.put("VarAmplFrom", p.stringValue());
        }
    }
    ...
    throws DalServerException {
        ...
        boolean retCsv=true, retVotable=true, retNative=true;
        int nFormats = 3;
        
        if (formats != null) {
            formats = formats.toLowerCase();
            retCsv = retVotable = retNative = false;
            nFormats = 0;
            
            if (formats.equals("all")) {
                retCsv = retVotable = retNative = true;
                nFormats = 3;
            } else {
    ...
    private void setMetadata(SsapParamSet params, RequestResponse r,
        ...
        if (format.equals("csv")) {
            ...
            r.setValue("Format", "text/xml;native");
    ...
    throws DalServerException {
        ...
        SpectrumKeywordFactory sdm = new SpectrumKeywordFactory(response);
        ...
        r.addParam(sdm.newParam("SpatialAxis", this.getUcd(s, "Coverage.Location.Sky")));
    ...
    throws DalServerException, InvalidDateException,
        ...
        if (args.length > 0 && args[0].equals("encode")) {
            ...
            JhuSsapService service = new JhuSsapService(null);
