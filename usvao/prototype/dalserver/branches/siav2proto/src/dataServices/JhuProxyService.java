...
public class JhuProxyService extends SsapService {
     ...
     */
    public JhuProxyService(SsapParamSet params) {
	super(params);
    }
...
private void buildQueryCone(SsapParamSet params)
	...
	throws DalServerException, DalOverflowException, InvalidDateException,
	IOException, FileNotFoundException {

	if (args.length > 0 && args[0].equals("encode")) {
	    // Test parameter encoding.
	    JhuProxyService service = new JhuProxyService(null);
