 ...
 * @author	Doug Tody
 */
public class ScsParamSet extends ParamSet implements Iterable {

    /** Create an initial default SCS parameter set. */
    public ScsParamSet() throws DalServerException, InvalidDateException {
	...
	this.getParam("FROM").setLevel(ParamLevel.SERVICE);
