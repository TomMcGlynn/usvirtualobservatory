...
public class KeywordFactory implements Iterable {
	...
	if (utype != null) map.put(utype, (Object)g);	// indexed by UTYPE
    }
	...
	if (utype != null) map.put(utype, (Object)p);	// indexed by UTYPE
    }
    ...
    /** 
     * return an iterator for the keywork id values.  The values can then 
     ...
     * be used to retrieve the corresponding parameter objects.  It is 
     * <i>not</i> assumed that all parameters have a utype; however, it is 
     * assumed that those which do will baee a unique utype.  This method 
     * is guaranteed to return the ids in the order they were added.  
     */
    public Iterator<String> utypeIterator() {
	return (utypes.iterator());
    }
    ...
    /**
     * return stored keyword instance associated with the given id or 
     * utype value, or null if there is no such keyword defined.
     * @returns either TableParam or TableGroup
     */
