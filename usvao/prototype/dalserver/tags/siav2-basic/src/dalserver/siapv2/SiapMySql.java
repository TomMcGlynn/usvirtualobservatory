...
public class SiapMySql {
	...
	// Spectral axis characterization.
	String specloc = getColumn(rs, "spectrallocation");
	String specres = getColumn(rs, "spectralresolution");
	String specpow = getColumn(rs, "spectralrespower");
	...
	r.setValue("SpectralLocation", specloc);
	r.setValue("SpectralResolution", specres);
	r.setValue("SpectralResPower", specpow);

	// Time axis characterization.
	r.setValue("TimeLocation", getColumn(rs, "timelocation"));
