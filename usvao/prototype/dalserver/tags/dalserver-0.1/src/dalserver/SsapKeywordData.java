package dalserver;
/**
 * Raw data for the SSA and Spectrum data models (this class is autogenerated).
 * See {@link dalserver.SsapKeywordFactory}.
 */
public class SsapKeywordData {
  ...
  "DatasetSize,Access.Size,,Estimated dataset size,,,long,,,bytes,Q,",
  ",,,,,,,,,,,",
  ...
  "DataLength,Spectrum.Length,, Number of points,SIZE,,long,,,,q,",
  "TimeSI,Spectrum.TimeSI, time;arith.zp, SI factor and dimensions,TIMESDIM,,double,,,,q,",
  "SpectralSI,Spectrum.SpectralSI,, SI factor and dimensions,SPECSDIM,,double,,,,q,",
  "FluxSI,Spectrum.FluxSI,, SI factor and dimensions,FLUXSDIM,,double,,,,q,",
  "",
  ...
  "TargetDescription,Spectrum.Target.Description,, Target description,OBJDESC,,char,*,,,,,,,,",
  ...
  "SpatialFill,Spectrum.Char.SpatialAxis.Coverage.Support.Fill, stat.fill;pos.eq, Spatial sampling filling factor,SKY_FILL,,float,,,,q",
  "SpatialStatError,Spectrum.Char.SpatialAxis.Accuracy.StatError, pos.eq;stat.error, Astrometric statistical error,SKY_ERR,,double,,deg,deg,q",
  "SpatialSysError,Spectrum.Char.SpatialAxis.Accuracy.SysError, pos.eq;stat.error.sys, Astrometric systematic error,SKY_SYE,,double,,deg,deg,q",
  "SpatialCalibration,Spectrum.Char.SpatialAxis.Accuracy.Calibration, meta.code.qual, Type of spatial coord calibration,SKY_CAL,,char,*,,,q",
  ...
  "SpectralStart,Spectrum.Char.SpectralAxis.Coverage.Bounds.Start, em;stat.min, Start in spectral coordinate,,,double,,,m,q",
  "SpectralStop,Spectrum.Char.SpectralAxis.Coverage.Bounds.Stop, em;stat.max, Stop in spectral coordinate,,,double,,,m,q",
  "SpectralFill,Spectrum.Char.SpectralAxis.Coverage.Support.Fill, stat.fill;em, Spectral sampling filling factor,SPEC_FIL,,float,,,,q",
  "SpectralBinSize,Spectrum.Char.SpectralAxis.Accuracy.BinSize, em;spec.binSize, Spectral coord bin size,SPEC_BIN,,double,,,m,q",
  "SpectralStatError,Spectrum.Char.SpectralAxis.Accuracy.StatError, em;stat.error, Spectral coord statistical error,SPEC_ERR,,double,,,m,q",
  "SpectralSysError,Spectrum.Char.SpectralAxis.Accuracy.SysError, em;stat.error, Spectral coord systematic error,SPEC_SYE,,double,,,m,q",
  "SpectralCalibration,Spectrum.Char.SpectralAxis.Accuracy.Calibration, meta.code.qual, Type of spectral coord calibration,SPEC_CAL,,char,*,,m,q",
  "SpectralResolution,Spectrum.Char.SpectralAxis.Resolution, spect.resolution, Spectral resolution FWHM,SPEC_RES,,double,,,m,q",
  ...
  "TimeExtent,Spectrum.Char.TimeAxis.Coverage.Bounds.Extent, time.expo, Total exposure time,EXPOSURE,,double,,,s,q",
  "TimeStart,Spectrum.Char.TimeAxis.Coverage.Bounds.Start, time.expo.start, Start time,TSTART,,double,,,d,q",
  "TimeStop,Spectrum.Char.TimeAxis.Coverage.Bounds.Stop, time.expo.end, Stop time,TSTOP,,double,,,d,q",
  "TimeFill,Spectrum.Char.TimeAxis.Coverage.Support.Fill, time;stat.fill;time, Time sampling filling factor,DTCOR,,float,,,,q",
  "TimeBinSize,Spectrum.Char.TimeAxis.Accuracy.BinSize, time.interval, Time bin size,TIMEDEL,,double,,,s,",
  "TimeStatError,Spectrum.Char.TimeAxis.Accuracy.StatError, time;stat.error, Time coord statistical error,TIME_ERR,,double,,,s,q",
  "TimeSysError,Spectrum.Char.TimeAxis.Accuracy.SysError, time;stat.error.sys, Time coord systematic error,TME_SYE,,double,,,s,q",
  "TimeCalibration,Spectrum.Char.TimeAxis.Accuracy.Calibration, meta.code.qual, Type of coord calibration,TIME_CAL,,char,*,,,q",
  "TimeResolution,Spectrum.Char.TimeAxis.Resolution, time.resolution, Temporal resolution FWHM,TIME_RES,,double,,,s,q",
  ",,,,,,,,,,",
  ...
  "FluxStatError,Spectrum.Char.FluxAxis.Accuracy.StatError, phot.flux;stat.error, Flux statistical error,STAT_ERR,,double,,,,q",
  "FluxSysError,Spectrum.Char.FluxAxis.Accuracy.SysError, phot.flux;stat.error.sys, Flux systematic error,SYS_ERR,,double,,,,q",
  "FluxCalibration,Spectrum.Char.FluxAxis.Accuracy.Calibration,, Type of flux calibration,FLUX_CAL,,char,*,,,q",
  ",,,,,,,,,,",
  ...
  "DataFluxStatError,Spectrum.Data.FluxAxis.Accuracy.StatError, phot.flux;stat.error, Flux symmetric statistical error,ERR,,double,,,,",
  "DataFluxStatErrLow,Spectrum.Data.FluxAxis.Accuracy.StatErrLow, phot.flux;stat.error;stat.min, Flux lower error,ERR_LO,,double,,,,",
  "DataFluxStatErrHigh,Spectrum.Data.FluxAxis.Accuracy.StatErrHigh, phot.flux;stat.error;stat.max, Flux upper error,ERR_HI,,double,,,,",
  "DataFluxSysError,Spectrum.Data.FluxAxis.Accuracy.SysError, phot.flux;stat.error.sys, Flux systematic error,SYS_ERR,,double,,,,",
  "DataFluxQuality,Spectrum.Data.FluxAxis.Quality, meta.code.qual;phot.flux, Flux measurement quality mask,QUALITY,4;@ID,long,,,,",
  ...
  "DataBkgModelStatError,Spectrum.Data.BackgroundModel.Accuracy.StatError, phot.flux;stat.error, Background model symmetric error,,,double,,,,",
  "DataBkgModelStatErrLow,Spectrum.Data.BackgroundModel.Accuracy.StatErrLow, phot.flux;stat.error;stat.min, Background model lower error,BG_ELO,,double,,,,",
  "DataBkgModelStatErrHigh,Spectrum.Data.BackgroundModel.Accuracy.StatErrHigh, phot.flux;stat.error;stat.max, Background model upper error,BG_EHI,,double,,,,",
  "DataBkgModelSysError,Spectrum.Data.BackgroundModel.Accuracy.SysError, phot.flux;stat.error.sys, Background model systematic error,BG_SYE,,double,,,,",
  "DataBkgModelQuality,Spectrum.Data.BackgroundModel.Quality, meta.code.qual;phot.flux, Background model quality mask,BGQUAL,,long,,,,",
  };
}
