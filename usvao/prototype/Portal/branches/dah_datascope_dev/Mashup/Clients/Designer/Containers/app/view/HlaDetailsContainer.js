Ext.define('Mvpc.view.HlaDetailsContainer', {
    ...
    constructor: function (config) {
        ...
        this.urlColumn = Mvp.util.TableUtils.getColumnbyUCD(this.columns, /VOX\:Image_AccessReference/);
        ...
        this.downloadButton.addListener('click', this.downloadRecords, this, {record: record, controller: this.controller});
    ...
    downloadRecords: function (obj, e, config) {
        Mvp.custom.Hla.downloadRecords(config.record, config.controller);
    }
});