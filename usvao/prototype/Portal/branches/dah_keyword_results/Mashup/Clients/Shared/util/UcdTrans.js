Ext.define('Mvp.util.UcdTrans', { statics: {
    // The dictionary is taken from "The UCD1+ controlled vocabulary Version 1.23"
    ucdDefs: {
        ...
        'em.IR.FIR': 'Far-Infrared, 30-1000 microns',
        ...
        'em.line.Lyalpha': 'Hydrogen Lyman alpha line',
        ...
        'meta.ref.url': 'URL, web address, service endpoint',
        ...
        'phot.color.reddFree': 'Dereddened, reddening-free color',
        ...
        'phys.atmol.qn': 'Atomic/molecular quantum number',
        ...
        'phys.size.diameter': 'Linear diameter',
        'phys.size.radius': 'Linear radius',
        ...
        'pos.frame': 'Reference frame used for positions (FK5, ICRS,..)',
        ...
        'pos.parallax.phot': 'Photometric parallax',
        ...
        'stat.param': 'Generic statistical arameter',
        ...
        'stat.value': 'Miscellaneous statistical value',
    ...
    translate: function(ucd) {
        var translation = '';
        
        var words = ucd.split(';');
        for(var i=0; i<words.length; i++){
            if( Mvp.util.UcdTrans.ucdDefs[words[i]] ){
                translation += Mvp.util.UcdTrans.ucdDefs[words[i]] + '. ';
            }else{
                if(i!=0){
                    translation += "; ";
                }
