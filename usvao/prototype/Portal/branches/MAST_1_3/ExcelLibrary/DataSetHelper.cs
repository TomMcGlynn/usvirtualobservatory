...
namespace ExcelLibrary
{
    ...
    public sealed class DataSetHelper
    {
        ...
        public static Workbook CreateWorkbook(DataSet dataset)
        {
		...
		public static void SaveWorkbook(DataSet dataset, String filePath)
        {
			Workbook workbook = CreateWorkbook(dataset);
