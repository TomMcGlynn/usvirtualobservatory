    ...
    Ext.Loader.setPath('Mvp', initializationPath + 'Shared');
    Ext.Loader.setPath('Mvpd', initializationPath + 'Designer/Exports/app');
    Ext.Loader.setPath('Mvpc', initializationPath + 'Designer/Containers/app');
