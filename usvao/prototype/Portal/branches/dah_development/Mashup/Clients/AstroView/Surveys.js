...
// TOAST 
ASTROVIEW.urls.toast.dummy.image    = ASTROVIEW.urls.proxy.masttest + "http://dummyimage.com/256x256/" + "ff0000" + "/000000%26text=%5B" + "[LEVEL]" + ":" + "[TX]" + "," + "[TY]" + "%5D";
...
// HEALPIX 
ASTROVIEW.urls.healpix.dummy.image  = ASTROVIEW.urls.proxy.masttest + "http://dummyimage.com/256x256/" + "ff0000" + "/000000%26text=%5B" + "[LEVEL]" + ":" + "[PIXEL12]" + "," + "[PIXEL]" + "%5D"; 
...
},
{
    ...
    "zoomTable": [{"fov":     30, "level": 4, "rax":   10, "decx":    10},
                  ...
                  {"fov":  0.355, "level":11, "rax":  0.1, "decx":   0.1},
                  {"fov":  0.125, "level":12, "rax":  0.05,"decx":  0.05},
                  {"fov": 0.0625, "level":12, "rax":  0.01,"decx":  0.01},
                  {"fov":0.00001, "level":12, "rax": 0.005,"decx": 0.005}]
}];
