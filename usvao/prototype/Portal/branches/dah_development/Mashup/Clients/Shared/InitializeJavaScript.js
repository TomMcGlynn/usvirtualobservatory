...
(function () {
    ...
    if (AppConfig.appLoadFile) {
        ...
        document.write('<script class="include" type="text/javascript" src="' + path + '/plugins/jqplot.cursor' + (AppConfig.isDebug ? '' : '.min.stsci') + '.js"></script>'); // since STSCI changed this source we have manually minify the source
