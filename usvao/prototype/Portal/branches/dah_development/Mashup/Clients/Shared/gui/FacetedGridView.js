    ...
    */
    ...
    constructor: function (config) {
        ...
        this.chartButton = Ext.create('Ext.button.Button', {
            icon: '../Shared/img/chart_24x24.png',
            scale: 'medium',
    ...
    createExtraItems: function (config) {
        ...
        if (this.controller.searchParams.batchSearchEnabled) {
            var batchSearchButton = this.grid.getBatchSearchButton();
            extraItems.push(batchSearchButton);
        }
