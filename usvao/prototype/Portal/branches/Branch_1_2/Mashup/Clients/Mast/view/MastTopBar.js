...
Ext.define('Mast.view.MastTopBar', {
    ...
    statics: {
        ...
        logoImageLocation: 'data/images/MAST_logo.png',
        logoWidth: 173,
        logoHeight: 71,
    ...
    constructor: function (config) {
        ...
        this.searchCallback = config.searchCallback;
        this.searchParams = config.searchParams;
		this.defaultSearch = config.defaultSearch;
        this.versionString = config.versionString;
        
        delete config.cbScope;
        delete config.searchCallback;
        ...
        var html = Mvp.util.Util.createLink(tbcStatics.tourHelpURL, 'User Guide') + ' | ' +
                '<a href="javascript: void(0)" onclick="Mast.view.AboutPanel.show(' + this.versionString + ')">';
        html += 'Demo Portal v' + this.versionString + '...</a>';
        html += ' | <a href="javascript: void(0)" onclick="Mvp.util.Uploader.showDialog(this)">Upload File...</a>';
    ...
    doSearch: function (searchText) {
        ...
        Ext.callback(this.searchCallback, this.cbScope, [searchText, searchParams]);
    },
