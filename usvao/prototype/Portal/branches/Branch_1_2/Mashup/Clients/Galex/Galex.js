...
{     
    var request = {};
    request.service = 'Vo.Galex.Cone';
    request.format = 'extjs';
    request.params = {ra: "9.0", dec: "-43.0", radius: ".05"};
    ...
    Ext.Ajax.request({ 
        ...
        failure: function(response, request) {
            Ext.log("getConeSearch: failure: ");
        	alert("getConeSearch: failure: " + response);
        },
    });
}
