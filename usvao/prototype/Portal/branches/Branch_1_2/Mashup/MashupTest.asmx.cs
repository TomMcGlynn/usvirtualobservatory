...
{	
    ...
    public class MashupTest : WebService 
    {		
		//
		// Logger Stuff
		//
		...
		[WebMethod]
        public void NedNameLookup(string input, string format, string timeout, string clearcache, string page, string pagesize, string columnsconfigid)
        {
			// Service Params
			MashupRequest r = new MashupRequest();		
			...
			r.page = page;
			r.pagesize = pagesize;
			r.columnsconfigid = columnsconfigid;
        ...
        [WebMethod]
        public void VoGalexCone(string ra, string dec, string radius, string format, string timeout, string clearcache, string page, string pagesize, string columnsconfigid)
        {	
			// Service Params
			MashupRequest r = new MashupRequest();
        ...
        [WebMethod]
        public void VoGenericTable(string url, string format, string timeout, string clearcache, string page, string pagesize, string columnsconfigid)
        {	
			// Service Params
			MashupRequest r = new MashupRequest();
        ...
        [WebMethod]
        public void CsvGenericTable(string url, string format, string timeout, string clearcache, string page, string pagesize, string columnsconfigid)
        {
			// Service Params
			MashupRequest r = new MashupRequest();
		...
		[WebMethod]
        public void VoInventoryCone(string ra, string dec, string radius, string format, string timeout, string clearcache, string page, string pagesize, string columnsconfigid)
        {
			// Service Params
			MashupRequest r = new MashupRequest();
		...
		[WebMethod]
        public void VoHlaCone(string ra, string dec, string radius, string catalog, string format, string timeout, string clearcache, string page, string pagesize, string columnsconfigid)
        {
			// Service Params
			MashupRequest r = new MashupRequest();
		...
		[WebMethod]
        public void HlaHubbleVotable(string ra, string dec, string radius, string format, string timeout, string clearcache, string page, string pagesize, string columnsconfigid)
        {
			// Service Params
			MashupRequest r = new MashupRequest();
		...
		[WebMethod]
        public void VoCaomTap(string MASHUP_PARAMS, string format, string timeout, string clearcache, string page, string pagesize, string columnsconfigid)
        {
			// Service Params
			MashupRequest r = new MashupRequest();
		...
		[WebMethod]
        public void VoHesarcDatascope(string ra, string dec, string radius, string format, string timeout, string clearcache, string page, string pagesize, string columnsconfigid)
        {
			// Service Params
			MashupRequest r = new MashupRequest();
		...
		[WebMethod]
        public void MastCaomCone(string ra, string dec, string radius, string format, string timeout, string clearcache, string page, string pagesize, string columnsconfigid)
        {
			// Service Params
			MashupRequest r = new MashupRequest();
        ...
        [WebMethod]
        public void VoGalexSiap(string ra, string dec, string radius, string format, string timeout, string clearcache, string page, string pagesize, string columnsconfigid)
        {
			// Service Params
			MashupRequest r = new MashupRequest();
		...
		[WebMethod]
        public void MastHlspProject(string MASHUP_PARAMS, string format, string timeout, string clearcache, string page, string pagesize, string columnsconfigid)
        {
			// Service Params
			MashupRequest r = new MashupRequest();
		...
		[WebMethod]
        public void MastHlspProducts(string id, string format, string timeout, string clearcache, string page, string pagesize, string columnsconfigid)
        {
			// Service Params
			MashupRequest r = new MashupRequest();
		...
		[WebMethod]
        public void MastGalexTile(string ra, string dec, string radius, string catalog, string maxrecords, string format, string timeout, string clearcache, string page, string pagesize, string columnsconfigid)
        {
			// Service Params
			MashupRequest r = new MashupRequest();
		...
		[WebMethod]
        public void MastGalexCatalog(string ra, string dec, string radius, string catalog, string maxrecords, string format, string timeout, string clearcache, string page, string pagesize, string columnsconfigid)
        {
			// Service Params
			MashupRequest r = new MashupRequest();
		...
		[WebMethod]
        public void MastGalexSdssCatalog(string ra, string dec, string radius, string catalog, string mission, string maxrecords, string format, string timeout, string clearcache, string page, string pagesize, string columnsconfigid)
        {
			// Service Params
			MashupRequest r = new MashupRequest();
		...
		[WebMethod]
        public void CaomConeVotable(string ra, string dec, string radius, string format, string timeout, string clearcache, string page, string pagesize, string columnsconfigid)
        {
			// Service Params
			MashupRequest r = new MashupRequest();
		...
		[WebMethod]
        public void AdsConeVotable(string ra, string dec, string radius, string format, string timeout, string clearcache, string page, string pagesize, string columnsconfigid)
        {
			// Service Params
			MashupRequest r = new MashupRequest();
		...
		[WebMethod]
        public void GalexSiapVotable(string MASHUP_PARAMS, string format, string timeout, string clearcache, string page, string pagesize, string columnsconfigid)
        {
			// Service params
			MashupRequest r = new MashupRequest();
