...
Ext.define('Vao.view.VaoTopBar', {
    ...
    statics: {
        ...
        tourHelpURL: 'data/VAO Docs/UserGuide/index.html',
        moreExamplesHelpURL: 'data/VAO Docs/UserGuide/index.html#Search',
    ...
    constructor: function (config) {
        ...
        this.exampleThreeDisplay = Ext.create('Ext.form.Label', {
            margin: '3 0 0 4',  // there is a tiny margin around the text input I can't get rid of
        ...
        this.exampleDisplay = Ext.create('Ext.form.Label', {
            margin: '3 0 0 2',  // there is a tiny margin around the text input I can't get rid of
            width: tbcStatics.exampleWidth + 100,
            html: html
        });
