...
namespace Mashup
{	
    public class MashupTest : Mashup 
    {		
		...
		[WebMethod]
        public void GalexPhotonList(string ra, string dec, string radius, string format)
        {
			// Service params
			MashupRequest r = new MashupRequest();
			r.service = "Galex.Photon.List";
			r.paramss["ra"] = ra;
			r.paramss["dec"] = dec;
			r.paramss["radius"] = radius;
		...
		[WebMethod]
        public void GalexPhotonListCount(string ra, string dec, string radius, string format)
        {
			// Service params
			MashupRequest r = new MashupRequest();
			r.service = "Galex.Photon.List.Count";
			r.paramss["ra"] = ra;
			r.paramss["dec"] = dec;
			r.paramss["radius"] = radius;
