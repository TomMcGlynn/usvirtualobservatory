...
Ext.define('Vao.Portal', {
    requires: ['Vao.view.VaoTopBar', 'Vao.view.VaoTopBarDownTime', 'Ext.util.Cookies', 'Vao.Version', 'Ext.ux.IFrame', 'Ext.layout.container.Border', 'Ext.container.Viewport', 'Mvp.search.SearchParams'],
    ...
    run: function () {
		...
		var src = AppConfig.startPage || 'http://www.usvao.org/documents/DataDiscoveryTool/StartPage/ddt_start_1.4.html';
