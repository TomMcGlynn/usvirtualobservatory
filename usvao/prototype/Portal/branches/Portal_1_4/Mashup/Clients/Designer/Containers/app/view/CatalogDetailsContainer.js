...
Ext.define('Mvpc.view.CatalogDetailsContainer', {
    ...
    loadRecords: function () {
        var tableURL = this.record.get('tableURL');
        ...
        if (tableURL) {
            ...
            sp.position = this.controller.position;  // Pass along the sky location for the new context.  (allows astroview to move there on tab selection)
            var searchInput = {
                inputText: tableURL,
                title: shortTitle,
