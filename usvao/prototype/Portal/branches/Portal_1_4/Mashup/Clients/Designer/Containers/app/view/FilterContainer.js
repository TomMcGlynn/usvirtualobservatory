Ext.define('Mvpc.view.FilterContainer', {
    ...
    requires: ['Mvp.util.Util', 'Mvpc.view.FacetChooserContainer', 'Mvpc.view.MinMaxSliderContainer', 'Ext.form.Panel', 'Ext.form.FieldSet', 'Ext.form.Checkbox', 'Ext.layout.container.Column', 'Mvpc.view.TextFacetContainer'],
    ...
    constructor: function (config) {
        ...
        this.passThrough = {};       // copy is passed to each MinMaxSliderContainer
    ...
    autoCreateFacets: function () {
        ...
        for (var i = 0, fhtLength = this.allColumns.length; i < fhtLength; i++) {
            ...
            if ((histType == 'numeric') || (type == 'int')) this.chartableFacets.allFacets[this.allColumns[i].dataIndex] = { niceName: cc.text || this.allColumns[i].dataIndex, index: i, chartType: ((histType == 'numeric') || (type == 'int')) ? 'Numeric' : 'Category', unit: (vot && vot.unit) || "" };
    ...
    update: function (histograms, finalHistogramTable) {
        ...
        while (f--) {
            ...
            var i = column.checkboxes.length;
