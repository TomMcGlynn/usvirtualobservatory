...
Ext.define('Mast.view.AboutPanel', {
    ...
    constructor: function(config) {
        ...
        var html = '<div style="text-align: center; margin: 0px;">' +
            ...
            'It is generally stable, but all components are to be considered as works ' +
            'in progress. Please contact the <a href="mailto:archive@stsci.edu?subject=Portal Feedback">MAST Portal Team</a>' +
            ' with any feedback, comments or suggestions.';
        config.html = html;
