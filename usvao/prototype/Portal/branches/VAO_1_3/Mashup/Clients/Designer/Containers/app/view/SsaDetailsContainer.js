...
Ext.define('Mvpc.view.SsaDetailsContainer', {
    ...
    constructor: function(config) {
        ...
        var titleColumn = Mvp.util.TableUtils.getColumnbyUCD(this.columns, /meta\.title/);
        if( !titleColumn ){
            titleColumn = Mvp.util.TableUtils.getColumnbyUCD(this.columns, /meta\.id/);
        }
        if( !titleColumn ){
            titleColumn = Mvp.util.TableUtils.getColumnbyUtype(this.columns, /Query\.LName/);
        }
        ...
        if( name.match(/NED\/SED/) ){
            ...
            var raColumn = Mvp.util.TableUtils.getColumnbyUCD(this.columns, /pos\.eq\.ra/);
            if( raColumn == null ){
                raColumn = Mvp.util.TableUtils.getColumnbyUCD(this.columns, /POS_EQ_RA_MAIN/i);
            }
            ...
            var decColumn = Mvp.util.TableUtils.getColumnbyUCD(this.columns, /pos\.eq\.dec/);
            if( decColumn == null ){
                decColumn = Mvp.util.TableUtils.getColumnbyUCD(this.columns, /POS_EQ_DEC_MAIN/i);
            }
    ...
    downloadRecords: function() {
        ...
        var urlColumn = Mvp.util.TableUtils.getColumnbyUCD(this.columns, /meta\.ref\.url/);
        var url = this.record.get(urlColumn);
        (Mvp.util.Util.isFtpUrl(url)) ? Mvp.util.Exporter.download(url) : Mvp.util.Exporter.downloadUrl(this.record.get(urlColumn), this.makeName());
    },
    ...
    broadcastSpectra: function() {
        ...
        if( name.match(/NED\/SED/) ){
            ...
            var urlColumn = Mvp.util.TableUtils.getColumnbyUCD(this.columns, /meta\.ref\.url/);
            if( urlColumn == null ){
                urlColumn = Mvp.util.TableUtils.getColumnbyUCD(this.columns, /data_link/i);
            }
        
            var ucdColumn = Mvp.util.TableUtils.getColumnbyUCD(this.columns, /VOX\:Spectrum_Format/);
            if( ucdColumn ){
                rowMeta['VOX:Spectrum_Format'] = this.record.get(ucdColumn);
            }
        
            var utypeColumn = Mvp.util.TableUtils.getColumnbyUtype(this.columns, /Access\.Format/);
            if( utypeColumn ){
            ...
            var utypeColumn = Mvp.util.TableUtils.getColumnbyUtype(this.columns, /Dataset\.Length/);
            if( utypeColumn ){
    ...
    getType: function() {
        var typeColumn = Mvp.util.TableUtils.getColumnbyUCD(this.columns, /VOX\:Spectrum_Format/);
        if( !typeColumn ){
            typeColumn = "format";
        }
