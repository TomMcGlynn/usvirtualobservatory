        ...
        if (allColumns) {
            for (c in allColumns) {
                ...
                if ((col.datatype == 'double') || (col.datatype == 'float')) {
                    ...
                    histObj.hist = Mvp.util.Util.decimalHistogram(this.getFilteredRecords(), col.dataIndex, minmax.min, minmax.max, Mvp.util.Constants.NUMERIC_HISTOGRAM_BUCKETS, ignoreValue);
