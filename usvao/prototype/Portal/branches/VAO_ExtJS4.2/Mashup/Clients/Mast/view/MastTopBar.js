...
Ext.define('Mast.view.MastTopBar', {
    ...
    statics: {
        ...
        logoImageLocation: (AppConfig.isDevelopment) ? 'data/images/spinning.jpg': 'data/images/mastlogo_thumb.png',
        logoWidth: 75,
        logoHeight: 75,
        ...
        openImportWindow: function () {
            if (!this.importWindow) this.importWindow = Ext.create('Mvpc.view.ImportTableContainer', { portalScope: this });
    ...
    constructor: function (config) {
        ...
        this.importButton = Ext.create('Ext.button.Button', {
            icon: Mvp.util.Constants.IMPORT_ICON[Mvp.util.Constants.ICON_SIZE],
            tooltip: 'Import File',
        ...
        this.importButton.addListener('click', Mast.view.MastTopBar.openImportWindow, this, this.id);

        this.downloadBasketButton = Ext.create('Ext.button.Button', {
            icon: Mvp.util.Constants.BASKET_ICON[Mvp.util.Constants.ICON_SIZE],
            tooltip: 'Download Basket is Empty',
            scale: Mvp.util.Constants.ICON_SIZE,
            scope: this,
            shadow: true,
            style: 'border: 1px solid #000000;', // The 'border' config has no effect, overriding the toolbar button style is a pain
        ...
        this.helpButton = Ext.create('Ext.button.Button', {
            icon: Mvp.util.Constants.HELP_ICON[Mvp.util.Constants.ICON_SIZE],
        ...
        var container = Ext.create('Ext.container.Container', { items: [this.infoBar, this.importButton, this.downloadBasketButton, this.helpButton] });
        ...
        em.addListener('APP.context.DownloadBasket.changed', this.downloadBasketChanged, this);
    },
    ...
    basketPressed: function () {
        this.fireEvent('APP.download.view', { type: 'APP.download.view' })
    },
    ...
    downloadBasketChanged: function () {
        if (Mvp.app.DownloadBasket.hasFiles()) {
            this.downloadBasketButton.enable();
            this.downloadBasketButton.setTooltip('Display Download Basket');
        } else {
            this.downloadBasketButton.disable();
            this.downloadBasketButton.setTooltip('Download Basket is Empty');
        }
    }
});