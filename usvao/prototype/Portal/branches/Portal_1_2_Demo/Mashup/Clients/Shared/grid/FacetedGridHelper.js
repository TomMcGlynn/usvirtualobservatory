...
Ext.define('Mvp.grid.FacetedGridHelper', {
    ...
    setupFacetPanel: function () {
        ...
        var config = { store: this.grid.store, columns: keys, chartableFacets: this.chartableFacets, niceColumnNames: this.niceColumnNames, exclude: this.exclude, gridColumns: this.grid.columns, autoFacetRules: this.autoFacetRules };
    ...
    createDockedItems: function () {
        ...
        if (isDevelopment) {
            ...
            dockedItems = [{
                ...
                height: 28,
                items: [
                        this.statusLabel, this.reloadButton, this.cancelButton, '->', this.layerChooser, this.colorPicker, this.exportButton, this.resolveLabel
                ] // '->' used to right justify next element
            }];
        }
        else {
