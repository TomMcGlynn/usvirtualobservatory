...
(function () {
    ...
    avPlacement = getUrlParam('avPlacement', queryString, 'east').toLowerCase();
    if (avPlacement == 'w') avPlacement = 'west';
    if (avPlacement == 'n') avPlacement = 'north';
    if (avPlacement == 's') avPlacement = 'south';
    if ((avPlacement != 'south') && (avPlacement != 'west') && (avPlacement != 'north')) avPlacement = 'east';
