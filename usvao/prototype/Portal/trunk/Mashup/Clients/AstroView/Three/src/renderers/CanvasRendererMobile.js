 ...
 * Adapted from CanvasRendererMobile built by
...
THREE.CanvasRendererMobile = function (parameters)
{
    ...
    // Twr: added access to underlying Context
    ...
    {        
        ...
        {
            console.error('THREE.CanvasRendererMobile.render: camera is not an instance of THREE.Camera.');
            return;
        }
        ...
        function renderFace3(v1, v2, v3, uv1, uv2, uv3, element, material, scene)
        {
            ...
            {
                if (material.map !== null && material.opacity && material.opacity > 0.0)
                {
                    if (material.map.mapping instanceof THREE.UVMapping && material.map.image)
                    {
                        _uvs = element.uvs[0];
                        clipImage(_v1x, _v1y, _v2x, _v2y, _v3x, _v3y, _uvs[uv1].x, _uvs[uv1].y, _uvs[uv2].x, _uvs[uv2].y, _uvs[uv3].x, _uvs[uv3].y, material.map.image);
