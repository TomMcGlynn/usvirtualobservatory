...
Ext.define('Mvpd.view.ExportToWindowCombos', {
    ...
    requires: ['Mvp.util.SampManager', 'Ext.data.Store', 'Ext.data.reader.Json'],
    statics: {
        optionMap: {
    ...
    sampBroadcast: function () {
        ...
        if (table) {
            ...
            Mvp.util.SampManager.sendTable({ filename: strippedTitle, data: table });
        } else {
