...
Ext.define('Mvp.custom.FullSearch', {
    ...
    statics: {
        ...
        categoryIconRenderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
            ...
            switch (value) {
                case 'ConeSearch': html = '<center><img title="A Catalog of Objects" alt="A Catalog of Objects" src="' + Mvp.util.Constants.CATALOG_ICON[Mvp.util.Constants.ICON_SIZE] + '" /></center>'; break;
                case 'SimpleImageAccess': html = '<center><img title= "A Collection of Images" alt= "A Collection of Images" src="' + Mvp.util.Constants.IMAGE_ICON[Mvp.util.Constants.ICON_SIZE] + '" /></center>'; break;
                case 'SimpleSpectralAccess': html = '<center><img title="A Collection of Spectra" alt="A Collection of Spectra" src="' + Mvp.util.Constants.SPECTRA_ICON[Mvp.util.Constants.ICON_SIZE] + '" /></center>'; break;
                case 'Observation': html = '<center><img title="A Collection of Observations" alt="A Collection of Observations" src="' + Mvp.util.Constants.OBSERVATION_ICON[Mvp.util.Constants.ICON_SIZE] + '" /></center>'; break;
                default: html = '';
            }
            return html;
        },
