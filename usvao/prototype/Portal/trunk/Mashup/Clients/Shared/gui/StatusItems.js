Ext.define('Mvp.gui.StatusItems', {
    ...
    computeStatusText: function(updateObject) {
        ...
        var itemType = (this.controller.searchParams.uid.match('CAOMDownload') !== null) ? 'Files' : 'Rows'
        ...
        if (this.controller.searchParams.uid.match('CAOMDownload') !== null) { // add more info for download baskets
    ...
    currentDatasetCount: function(updateObject) {   // specific to CAOMDownload
        ...
        store.each(function (record) {
            var obsId = record.get('obsID') || record.get('obsid');
