...
Ext.define('Mvp.util.ExtBugWorkarounds', {
    ...
    statics: {
        ...
        addClsOverride: function () {   // when filtering, sometimes a button element is null and the library doesn't have a check for it
            Ext.override(Ext.Component, {
                addCls: function (direction) {
                    var me = this,
                    el = me.rendered ? me.el : me.protoEl;

                    if (el) el.addCls.apply(el, arguments);
                    return me;
                }
            });
        }
