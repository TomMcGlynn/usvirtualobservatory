...
Ext.define('Mvpc.view.FacetChooserContainer', {
    ...
    constructor: function (config) {
        ...
        for (var i in this.allFacets) {
            ...
            var column = this.columns[this.allFacets[i].index];
            var key = column.dataIndex;
            var label = column.text || key;
        ...
        for (var i in this.decimalFacets) {
            ...
            var column = this.columns[this.decimalFacets[i].index];
            var key = column.dataIndex;
            var label = column.text || key;
            var cb = Ext.create('Ext.form.Checkbox', {
                xtype: 'checkboxField',
            ...
            while (j--) {
                if (key == this.selectedDecimalFacets[j].column.dataIndex) {
                    cb.setValue(true);
                    break;
                }
            }
