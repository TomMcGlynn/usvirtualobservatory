...
Ext.define('Mvp.filters.FacetFilterPanel', {
    ...
    statics: {
        createFacetFilterPanel: function(sourceGrid, sourceStore, columnName, title, separator) {
    ...
    constructor: function(config) {
        ...
        me.histogram = Mvp.filters.FilterTest.histogram(me.sourceStore.getCache(), me.columnName, me.separator);
        me.histArray = Mvp.filters.FilterTest.histogramToArray(me.histogram);
        ...
        Ext.apply(config, {
            ...
            selModel: sm,
            columns: [
                {text: "Value", width: 180, dataIndex: 'key'},
    ...
    selectionListener: function(selModel, selected) {
        ...
        if ((selected.length > 0) && (selected.length != me.sourceStore.getCount())) {
            filter = {
