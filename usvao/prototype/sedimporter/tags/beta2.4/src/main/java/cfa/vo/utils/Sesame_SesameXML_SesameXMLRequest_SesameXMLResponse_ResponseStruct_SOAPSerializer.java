...
public class Sesame_SesameXML_SesameXMLRequest_SesameXMLResponse_ResponseStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public Sesame_SesameXML_SesameXMLRequest_SesameXMLResponse_ResponseStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        cfa.vo.utils.Sesame_SesameXML_SesameXMLRequest_SesameXMLResponse_ResponseStruct instance = new cfa.vo.utils.Sesame_SesameXML_SesameXMLRequest_SesameXMLResponse_ResponseStruct();
        cfa.vo.utils.Sesame_SesameXML_SesameXMLRequest_SesameXMLResponse_ResponseStruct_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_return_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new cfa.vo.utils.Sesame_SesameXML_SesameXMLRequest_SesameXMLResponse_ResponseStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        cfa.vo.utils.Sesame_SesameXML_SesameXMLRequest_SesameXMLResponse_ResponseStruct instance = (cfa.vo.utils.Sesame_SesameXML_SesameXMLRequest_SesameXMLResponse_ResponseStruct)obj;
