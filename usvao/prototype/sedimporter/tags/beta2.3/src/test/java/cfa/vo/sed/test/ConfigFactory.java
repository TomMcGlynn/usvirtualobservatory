...
public class ConfigFactory {
    ...
    public static void main(String[] args) throws Exception {
        URL outconfig = new URL("file:///Users/olaurino/Projects/SedImporter/src/test/resources/test_data/spvquantities.ini");

        List<ISetup> confList = getAllSPVQuantitiesConfigurations();

        SetupManager.write(confList, outconfig);
    }

    public static List<ISetup> getAllSPVQuantitiesConfigurations() throws Exception {
