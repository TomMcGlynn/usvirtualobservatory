...
public class LoadSetupDialog extends javax.swing.JDialog {
    ...
    private void jButton1browse(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1browse
        ...
        if(returnval == JFileChooser.APPROVE_OPTION) {
            ...
            setFilePath("file://"+f.getAbsolutePath());
        }
    ...
    private void load(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_load
        ...
        try {
            List<ISetup> confList = SetupManager.read(new URL(filePath));
            List<Segment> segList = SegmentImporter.getSegments(confList);
            NewSedFrame frame = new NewSedFrame("mySed");
            ...
            if(confList.get(0).getTargetRa()!=null && confList.get(0).getTargetDec()!=null) {
                frame.setRa(Double.valueOf(confList.get(0).getTargetRa()));
                frame.setDec(Double.valueOf(confList.get(0).getTargetDec()));
            }
