...
public final class SetupFrame extends ConfirmJInternalFrame {
    ...
    public void setRa(Double ra) {
        ...
        if(ra!=null)
            confBean.setTargetRa(ra.toString());
    }
    private Double dec;
    ...
    public void setDec(Double dec) {
        ...
        if(dec!=null)
            confBean.setTargetDec(dec.toString());
    }
    ...
    public SetupFrame(String name, ISegmentMetadata metadata, NewSedFrame sedFrame, String fileUrl, IFileFormat format) {
        super(name);
        initComponents();
        SetupBean c = new SetupBean();
        c.setFileLocation(fileUrl);
        c.setFormatName(format.getName());
        ...
        setSedID(sedFrame.getSedID());
        setFileUrl(fileUrl);

        setRa(sedFrame.getRa());
        setDec(sedFrame.getDec());
        setTargetName(sedFrame.getTargetName());

        this.sedFrame = sedFrame;
    ...
    private void initComponents() {
        ...
        jPanel5.add(jRadioButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 100, -1, -1));
        ...
        jPanel5.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 60, 176, -1));
        ...
        jPanel5.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 100, 340, -1));
        ...
        jPanel5.add(jComboBox4, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 140, 340, -1));
        ...
        jPanel5.add(jRadioButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, -1, -1));
    ...
    private void importSegment(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_importSegment
        ...
        try {
            List<Segment> segments = SegmentImporter.getSegments(confBean);
            sedFrame.addSegments(segments);
            this.dispose();
    ...
    private void save(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save
        SaveSetupDialog dia = new SaveSetupDialog(MainView.getInstance(), confBean);
        dia.setVisible(true);
    }//GEN-LAST:event_save
    ...
    private class ColumnConverter extends org.jdesktop.beansbinding.Converter {
        ...
        public Object convertReverse(Object value) {
            ...
            if(Number.class.isAssignableFrom(col.getContentClass())) {
