...
package cfa.vo.sed.configuration;
...
public class ConfigurationManagerTest {
    ...
    public static void setUpClass() throws Exception {
        ...
        List<ISetup> confList = ConfigFactory.getAllSPVQuantitiesConfigurations();
    ...
    public void testConfigurationIOQuantities() throws Exception {
        ...
        URL fileURL = URLTestConverter.getURL("test:///test_data/spvquantities.ini");
        System.out.println(fileURL);
        List<ISetup> expResult = ConfigFactory.getAllSPVQuantitiesConfigurations();
