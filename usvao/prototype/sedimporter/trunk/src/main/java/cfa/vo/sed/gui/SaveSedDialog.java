...
public final class SaveSedDialog extends javax.swing.JDialog {
    ...
    public SaveSedDialog(java.awt.Frame parent, SedWrapper sedWrapper, String sedName) {
        super(parent, true);
        initComponents();
    ...
    private void save(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save
        try {
            ...
            int resp = NarrowOptionPane.YES_OPTION;
                if(f.exists()) {
                    resp = NarrowOptionPane.showConfirmDialog(MainView.getInstance(),
