...
public class PluginManager extends javax.swing.JInternalFrame {
    ...
    private static class Holder {
        private static final LoadPluginDialog LOADPLUGINDIALOG = new LoadPluginDialog(MainView.getInstance(), true);
    }
    ...
    public void load() {
        try {
            ...
            NarrowOptionPane.showMessageDialog(MainView.getInstance(), ex.getClass()+ex.getMessage(), "Error", NarrowOptionPane.ERROR_MESSAGE);
        }
    }
