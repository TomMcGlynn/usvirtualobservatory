...
public final class WebFile {
    ...
    /** Open a web file. */
    public WebFile( String urlString,int timeout )
        ...
        // Set up a request.
        conn.setConnectTimeout( timeout);     //set by user
        conn.setReadTimeout( timeout);       // set by user
    ...
    private Object readStream( int length, java.io.InputStream stream )
        ...
        catch ( java.io.UnsupportedEncodingException e ) { System.out.println("WebFile class cannot parse response " + e);}
        return bytes;
    }
