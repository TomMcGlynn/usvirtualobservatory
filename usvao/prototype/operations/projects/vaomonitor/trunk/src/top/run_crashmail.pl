...
sub process
{
	...
	{
	    print "the current test isn't passing, and the last one was passing. Sending mail\n";
	    print "GG: $email->{$service}\n";
...
sub storemorehistory
{
	...
	my $status = get_last_validation($con,$service,"getPenultimateStats");
