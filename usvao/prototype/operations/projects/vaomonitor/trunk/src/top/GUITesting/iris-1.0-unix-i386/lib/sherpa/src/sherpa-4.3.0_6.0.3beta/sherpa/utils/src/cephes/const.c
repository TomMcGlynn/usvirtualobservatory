...
inline static float __inff(void)
{
    const union { unsigned int i; float f;} b = {0x7f800000UL};
    return b.f;
}

inline static float __nanf(void)
{
    const union { unsigned int i; float f;} b = {0x7fc00000UL};
    return b.f;
}

#ifdef INFINITIES
#define INFINITY ((double)__inff())
#else
double INFINITY =  1.79769313486231570815E308;    /* 2**1024*(1-MACHEP) */
#endif
#ifdef NANS
#define NAN ((double)__nanf())
#else
double NAN = 0.0;
#endif
#ifdef MINUSZERO
