...
##
##   Automatic keywords:
##   $Date: 2010-09-23 12:25:09 +0200 (Thu, 23 Sep 2010) $
##   $Revision: 517 $
##   $Author: luigi $
##   $HeadURL: http://cosmos.iasf-milano.inaf.it/svn/fase/trunk/framework/samp/python/sampy.py $
##   $Id: sampy.py 517 2010-09-23 10:25:09Z luigi $
##
################################################################################
...
__url__ = "http://cosmos.iasf-milano.inaf.it/pandora/sampy.html"
__description__ = "Python SAMP protocol implementation"
__long_description__ = "This module contains classes to create a SAMP Hub and/or interface an application to a running SAMP Hub and create a SAMP Callable Client (Standard Profile)."
__status__ = "release"
__release__ = "1.2.0"
__revision__ = "$Revision: 517 $"
__date__ = "$Date: 2010-09-23 12:25:09 +0200 (Thu, 23 Sep 2010) $"
  ...
  if PYTHON_VERSION > 2.5:
    ...
    def do_POST(self):
      ...
      try:
        ...
        if method in ('samp.hub.notify', 'samp.hub.notifyAll', 
...
class SAMPHubServer(object):
  ...
  def __init__(self, secret = None, addr=None, port=0, lockfile=None, timeout = 0, \
               ...
               cert_reqs = 0, ca_certs = None, ssl_version = 2):
    """
  ...
  def _setupHubAsClient(self):
    ...
    self._declareMetadata(self._hub_private_key, {"samp.name": "Hub",
                                                  ...
                                                  "provider.name": "PANDORA",
                                                  "provider.url": "http://cosmos.iasf-milano.inaf.it/pandora",
                                                  "samp.documentation.url": "http://cosmos.iasf-milano.inaf.it/pandora/docs/samp/",
                                                  "samp.icon.url": "http://cosmos.iasf-milano.inaf.it/pandora/images/sampy-icon.png"})
