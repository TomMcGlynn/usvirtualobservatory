...
##################################optmethods###################################
    ...
    Extension('sherpa.utils._psf',
              ...
              libraries=(cpp_libs + ['sherpa','fftw3','fftw3f']),
              depends=(get_deps(['extension', 'utils'])+
    ...
    # sherpa.astro.group._group
    Extension('sherpa.astro.group._group',
              ['sherpa/astro/group/_group.c',
               'sherpa/astro/group/grplib.c',
               'sherpa/astro/group/grp_priv.c',
               'sherpa/astro/group/stub_dserr.c',
               ] + glob.glob('sherpa/astro/group/dserror*.c'),
              (sherpa_inc + ['sherpa/astro/group/']),
              libraries=cpp_libs,
              depends=(get_deps(['extension'])+
                       ['sherpa/astro/group/grplib.h',
                        'sherpa/astro/group/grp_priv.h',
                        'sherpa/astro/group/pygrplib.h',
                        'sherpa/astro/group/stub_dserr.h'
                        ]))
    ]
...
setup(name='sherpa',
      ...
      package_data={'sherpa': ['include/sherpa/*.hh',
                    ...
                    'sherpa.astro.group': ['tests/test_*.py'],
