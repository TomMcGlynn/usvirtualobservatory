...
#
#
package HTML::BannerVAOStats;

use Exporter();
@ISA = qw (Exporter);
@EXPORT = qw (print_banner);

sub print_banner()
{
print  << "   EOF";
 <BODY onload = run_convert()><a href='#content' title='Skip navigation'> </a>
<script type = "text/JavaScript">
  ...
  <tr>   
     <td width="112" height="32" align="center" valign="top">
        ...
        <span class="nvolink">
        <a href="http://www.us-vo.org/" target="_top">National Virtual Observatory</a>
        </span>
     </td>   
     <td valign="top"><table  width="100%" border="0" cellpadding="0" cellspacing="0">      
       <tr>       
         <td width="0" height="30" bgcolor="white"></td>
         <td width="676" height="39" align="center" valign="middle" 
         background="http://www.us-vo.org/images/templatestars.jpg" bgcolor="#CFE5FC"  class="nvoapptitle" style="background-repeat: repeat-y;">
         

         
        <span class= \"nvoapptitle\" style= \"background\-repeat: repeat\-y;\">VAO Monitor</span></td></tr>
    </td>
    ...
    <td bgcolor="white" width="2"></td>      
     ...
     <td  class='navlink'><a href='/vo/vaomonitor/stats.html'>VO Statistics Calculator </a></td>
     <td  class='navlink'><a href='/vo/vaomonitor/vaomonitor.pl'>VAO Monitor </a></td>
