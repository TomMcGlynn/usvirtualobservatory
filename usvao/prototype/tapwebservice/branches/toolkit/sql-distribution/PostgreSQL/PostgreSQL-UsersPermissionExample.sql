...
**/
create user datauser with password  'datauser123';
grant select on data_schema.* to datauser; 

create schema upload_schema;
create user with password  'uploaduser123';
grant select,insert,update,create on upload_schema.* to uploaduser; 
grant select on data_schema.* to uploaduser;
grant select on upload_schema.* to datauser;

create user tapuser with password  'tapuser123';
grant select,insert,update,create on tap_schema.* to tapuser; 
grant select on tap_shema.* to datauser;
