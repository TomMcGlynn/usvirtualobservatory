        ...
        <html>
            <head>
                ...
                <script type="text/javascript">
                 function submit(){
                        ...
                        document.getElementById('destructForm').action='/<xsl:value-of select="uws:job/uws:jobId"/>/phase';
                        alert("Updated");
                 }
            ...
            <body onLoad= "">
                ...
                <tr>
                    ...
                    <td><textarea rows="1" cols="40" id="PHASE" name = "PHASE" >
                        <xsl:value-of select="uws:job/uws:phase"/>
                        </textarea> 
