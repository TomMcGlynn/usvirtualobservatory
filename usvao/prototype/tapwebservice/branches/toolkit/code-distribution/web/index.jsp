...
<html>
    ...
    <body>
        <h1>TAP webservice </h1>
        <p> This service implements the IVOA TAP  recommendation and exposes the tables. 
...
<b>Sample queries:</b><br/>
   ...
   <br/>WHERE  DBO.FSPHREGIONCONTAINSXYZ(DBO.FSPHSIMPLIFYSTRING('CIRCLE J2000 180 0 0.3'), O.CX ,O.CY,O.CZ)   = 1 
    ...
    The above example of a spatial/positional query to database, we are not supporting positional queries completely yet as this issue is still under discussion with VO. 
    <br/>
    <table border="1px">
        <tr>
        ...
        <tr><td><a href="<%=webServiceLink%>/tap/async/"jobid"/phase"><%=webServiceLink%>/tap/async/"jobid"/phase</a> </td> <td>implemented</td> </tr>
        <tr><td><a href="<%=webServiceLink%>/tap/async/"jobid"/executionduration"> <%=webServiceLink%>/tap/async/"jobid"/executionduration</a></td> <td>implemented</td> </tr>
        <tr><td><a href="<%=webServiceLink%>/tap/async/"jobid"/destruction"><%=webServiceLink%>/tap/async/"jobid"/destruction</a> </td> <td>implemented</td> </tr>
        <tr><td><a href="<%=webServiceLink%>/tap/async/"jobid"/error" ><%=webServiceLink%>/tap/async/"jobid"/error</a> </td> <td>implemented</td> </tr>
        <tr><td><a href="<%=webServiceLink%>/tap/async/"jobid"/parameters"><%=webServiceLink%>/tap/async/"jobid"/parameters</a> </td> <td>implemented</td> </tr>
        <tr><td><a href="<%=webServiceLink%>/tap/async/"jobid"/results/result"><%=webServiceLink%>/tap/async/"jobid"/results/result</a> </td> <td>implemented</td> </tr>
        <tr><td><a href="<%=webServiceLink%>/tap/async/"jobid"/starttime"><%=webServiceLink%>/tap/async/"jobid"/starttime</a> </td> <td>implemented</td> </tr>
        <tr><td><a href="<%=webServiceLink%>/tap/async/"jobid"/endtime"><%=webServiceLink%>/tap/async/"jobid"/endtime</a> </td> <td>implemented</td> </tr>
        <tr><td><a href="<%=webServiceLink%>/tap/async/"jobid"/owner"><%=webServiceLink%>/tap/async/"jobid"/owner</a></td> <td>Not implemented (provision made in code to implement this if needed) </td> </tr>
        <tr><td><a href="<%=webServiceLink%>/tap/async/"jobid"/quote"><%=webServiceLink%>/tap/async/"jobid"/quote</a> </td> <td> NOT implemented </td> </tr>
    </table>
    <br/>
