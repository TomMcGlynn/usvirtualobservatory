...
//extends JerseyTest
{
    ...
    public void testDatabaseConnection() throws SQLException, ClassNotFoundException{
        ...
        int i = 0;
        while(rs.next()){i++;}
        org.junit.Assert.assertEquals(true,(i>0));
    ...
    public void testSync() {     
        WebResource webResource = com.sun.jersey.api.client.Client.create().resource("http://localhost:8080/sdss/tap/sync");
    ...
    public void testAsync() {     
        WebResource webResource = com.sun.jersey.api.client.Client.create().resource("http://localhost:8080/sdss/tap/async");
        //Response resp = webResource.path("sync").entity(this);
        MultivaluedMap formData = new MultivaluedMapImpl();
        formData.add("REQUEST", "doQuery");
        formData.add("LANG", "ADQL");
    ...
    public void testallAsync(){
        String jobid = "b2b17c3b-d9d7-4981-9f30-ff616b504575";
    ...
    public void testAsyncPhase(String jobid) {   
        WebResource webResource = com.sun.jersey.api.client.Client.create().resource("http://localhost:8080/sdss/tap/async/"+jobid+"/phase");
        //Response resp = webResource.path("sync").entity(this);
        ClientResponse response = webResource.get(ClientResponse.class);  
        assertEquals( 200, response.getStatus());
    ...
    public void testAsyncStarttime(String jobid) {   
        WebResource webResource = com.sun.jersey.api.client.Client.create().resource("http://localhost:8080/sdss/tap/async/"+jobid+"/starttime");
        //Response resp = webResource.path("sync").entity(this);
        ClientResponse response = webResource.get(ClientResponse.class);  
        assertEquals( 200, response.getStatus());
    ...
    public void testAsyncEndtime(String jobid) {   
        WebResource webResource = com.sun.jersey.api.client.Client.create().resource("http://localhost:8080/sdss/tap/async/"+jobid+"/endtime");
        //Response resp = webResource.path("sync").entity(this);
        ClientResponse response = webResource.get(ClientResponse.class);  
        assertEquals( 200, response.getStatus());
    ...
    public void testAsyncDuration(String jobid) {   
        WebResource webResource = com.sun.jersey.api.client.Client.create().resource("http://localhost:8080/sdss/tap/async/"+jobid+"/executionduration");
        //Response resp = webResource.path("sync").entity(this);
        ClientResponse response = webResource.get(ClientResponse.class);  
        assertEquals( 200, response.getStatus());
    ...
    public void testAsyncDestruction(String jobid) {   
        WebResource webResource = com.sun.jersey.api.client.Client.create().resource("http://localhost:8080/sdss/tap/async/"+jobid+"/destruction");
        //Response resp = webResource.path("sync").entity(this);
        ClientResponse response = webResource.get(ClientResponse.class);  
        assertEquals( 200, response.getStatus());
    ...
    public void testAsyncParameters(String jobid) {   
        WebResource webResource = com.sun.jersey.api.client.Client.create().resource("http://localhost:8080/sdss/tap/async/"+jobid+"/parameters");
        //Response resp = webResource.path("sync").entity(this);
        ClientResponse response = webResource.get(ClientResponse.class);  
        assertEquals( 200, response.getStatus());
    ...
    public void testAsyncJob(String jobid) {   
        WebResource webResource = com.sun.jersey.api.client.Client.create().resource("http://localhost:8080/sdss/tap/async/"+jobid);
        //Response resp = webResource.path("sync").entity(this);
        ClientResponse response = webResource.get(ClientResponse.class);  
        assertEquals( 200, response.getStatus());
...
//        WebResource webResource = com.sun.jersey.api.client.Client.create().resource("http://localhost:8080/sdss/tap/sync/upload");
//        //Response resp = webResource.path("sync").entity(this);
//        MultivaluedMap formData = new MultivaluedMapImpl();
//        File f = new File("C:\\Users\\deoyani\\Downloads\\result"); 
//        formData.add("FILE", f);
//        //formData.add("LANG", "ADQL");
//        //formData.add("QUERY", "SELECT TOP 10 ra FROM PhotoObjAll");
//        ClientResponse response = webResource.type("application/x-www-form-urlencoded").post(ClientResponse.class, formData);        
