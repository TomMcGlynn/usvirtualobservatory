...
insert into TAP_SCHEMA_schemas (schema_name,description,utype) values
( 'TAP_SCHEMA', 'a special schema to describe a TAP tableset', NULL )
;

insert into TAP_SCHEMA_tables (schema_name,table_name,table_type,description,utype) values
...
insert into TAP_SCHEMA_columns (table_name,column_name,description,utype,ucd,unit,datatype,size,principal,indexed,std) values
...
insert into TAP_SCHEMA_keys (key_id, from_table,target_table) values
...
insert into TAP_SCHEMA_key_columns (key_id,from_column,target_column) values
