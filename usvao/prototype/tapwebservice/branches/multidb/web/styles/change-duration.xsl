        ...
        <html>
            <head>
                ...
                <script type="text/javascript">
                 function submit(){
                        ...
                        document.getElementById('destructForm').action='/<xsl:value-of select="uws:job/uws:jobId"/>/executionduration';
                        alert("Updated");
                 }
            ...
            <body onLoad= "">
                ...
                <tr>
                    ...
                    <td><textarea rows="1" cols="40" id="TERMINATION" name = "TERMINATION" >
                        <xsl:value-of select="uws:job/uws:executionDuration"/>
                        </textarea> 
