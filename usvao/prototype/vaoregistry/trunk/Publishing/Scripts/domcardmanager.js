...
var resourceTypes = [
        ...
        { 'tag': 'vs:DataService', 'description': 'Data Service: A web page or other non-standard data service' },
...
function setupForms(app, resourceDOM, newResource, isCopy) {
    ...
    fillFormData(formPanel, resourceDOM, newResource, isCopy);
