...
checkAuthInfo = function () {
    Ext.Ajax.request({
        url: 'login.aspx?action=getauthID',
        method: 'GET',
        success: function (result, request) {
            var json = Ext.decode(result.responseText);
            if (json && json.success == true) {
                Ext.getCmp('identifier').setValue(json.details + '/');
            }
        },
                ...
                items: [
                    {
                        ...
                        {
                            id: 'identifier',
                            helpText: 'An unambiguous URI-style reference to the resource.  The ' +
                                       'syntax for Identifiers maintains that they must begin with the identifier of an institution already ' +
                                       'itself described in the Registry. Append resource-specific tags to this prefix; do not edit it. Ex: ivo://archive.stsci.edu/ssap/stis',
                    ...
                    },
                    {
                        ...
                        },
                        {
                            ...
                            items: [{
                                ...
                                items: [{
                                    name: 'date',
                                    helpText: 'Date associated with an event in the life cycle of the resource. This may be for keeping track of creation, or last update, or a timespan for data provided by a service.',
                                    fieldLabel: 'Date',
                                    emptyText: 'Date of interest for this resource',
                                    xtype: 'textfield',
                                    vtype: 'UTCDateTime',
