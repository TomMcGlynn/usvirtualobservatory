...
namespace Publishing
{
    ...
    {
        private static string sqlConnection = registry.Properties.Settings.Default.SqlConnection;
        private static string sqlAdminConnection = registry.Properties.Settings.Default.SqlAdminConnection;

        private static string vDir = Properties.Settings.Default.vdir; //don't inherit this from registry project.
        ...
        public static validationStatus GetEmptyResource(string identifier, ref XmlDocument doc)
        {
            ...
            try
            {
                System.IO.StreamReader myFile = new System.IO.StreamReader(vDir + "EmptyVOResource.xml");
