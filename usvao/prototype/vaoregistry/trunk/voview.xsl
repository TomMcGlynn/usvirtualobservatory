...
<xsl:variable name="SimpleQueryURL" select="'http://heasarc.gsfc.nasa.gov/cgi-bin/vo/squery/query.sh'" />
	...
	<td>
		...
		<a>
			<xsl:attribute name="href">
				<xsl:value-of select="concat('http://heasarc.gsfc.nasa.gov/cgi-bin/vo/squery/query.sh?IVOID=',TD[3])"/>
