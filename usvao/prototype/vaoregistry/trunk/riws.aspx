...
<p align="left">
    ...
    <p>
        &nbsp;</p><br />
<!--    <p align="left"> -->
        <table id="tblRIWS" border="0" cellpadding="0" cellspacing="15" width="80%" onclick="return tblRIWS_onclick()">
            <tr>
                <td width="120">
                    <p align="left">
            ...
            <tr>
                ...
                <td style="width: 523px; height: 16px;" valign="top">
                    <p align="left">
                        Provides basic access to Directory resource metadata in the IVOA Registry Interface
                        1.0 standard specification
                    </p>
                </td>
                <td style="width: 157px; height: 16px;" valign="top">
                    <p align="center">
                            <asp:HyperLink ID="lnkRIWS" runat="server" NavigateUrl="ristandardservice.asmx">RIStandardService.asmx</asp:HyperLink>
                    </p>
                </td>
                <td style="width: 179px; height: 16px;" valign="top">
                    <p align="center">
                        <asp:HyperLink ID="lnkRIWSWSDL" runat="server" NavigateUrl="ristandardservice.asmx?WSDL">wsdl</asp:HyperLink>
                    </p>
                </td>
            </tr>
            <tr>
    ...
    <p align="left">
    <ul><li>Automated Directory <a href="harvesttable.aspx">Harvesting</a> report page. 
    This contains the most recent results from STScI's automated Directory harvesting. 
    The page is automatically updated from the harvester's logging.<br />
    <li>Directory <a href="registryadmin.asmx">Local Administrative</a> web service. 
    This service can be used for harvesting of individual records and other 
