...
<VOTABLE xmlns="http://www.ivoa.net/xml/VOTable/v1.1">
   ...
   <xsl:template match="interface">
      <TR><xsl:text>
         ...
         <xsl:text>   </xsl:text>
         <TD><xsl:apply-templates select=".." mode="capShortName"/></TD><xsl:text>
</xsl:text>
         ...
         <xsl:text>   </xsl:text>
         <TD><xsl:apply-templates select=".." mode="capID"/></TD><xsl:text>
</xsl:text>
         <xsl:call-template name="valOrNull">
         ...
         <xsl:call-template name="valOrNull">
            <xsl:with-param name="val" select="accessURL[1]" />   
         </xsl:call-template>
         <xsl:call-template name="valOrNull">
