...
public class OAuthHelper {
    ...
    private enum operation {request, access, authorize, echo};

    public static void main(String[] argv) throws Exception {
        //new OAuthHelper().execute(operation.request+"");
        //new OAuthHelper().execute(operation.authorize+"");
        //new OAuthHelper().execute(operation.access+"");
        new OAuthHelper().execute("http://dimm.pha.jhu.edu:8081/vospace/echo");
    }


    public OAuthHelper() throws IOException {
        props = new Properties();
        propFile = new File("/Users/dmitry/tmp/consumer.properties");
