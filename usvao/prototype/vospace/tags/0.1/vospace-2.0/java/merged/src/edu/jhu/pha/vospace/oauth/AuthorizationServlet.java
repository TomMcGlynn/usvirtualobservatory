...
public class AuthorizationServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if (Boolean.TRUE.equals(accessor.getProperty("authorized"))) {
                ...
                sendToAuthorizePage(request, response, accessor, null);
            }
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        try{
            ...
            if(userId == null || password == null){
                sendToAuthorizePage(request, response, accessor, null);
            } else if(!MySQLOAuthProvider.checkUser(userId, password)) {
                sendToAuthorizePage(request, response, accessor, "Wrong username or password.");
        	} else {
                // set userId in accessor and mark it as authorized
                MySQLOAuthProvider.markAsAuthorized(accessor, userId);
        	}
            returnToConsumer(request, response, accessor);
    ...
    private void sendToAuthorizePage(HttpServletRequest request, 
            HttpServletResponse response, OAuthAccessor accessor, String error)
    throws IOException, ServletException{
