...
<h1 class="top">Welcome to the NVO Login Registration Portal</h1>
...
<p>
You are about to create your own <a
href="http://nvo-test.noao.edu/noaonvo/NvoSingleSignOn.shtml">VO
Logon</a>&#8212;a single unique identity which you can use to log onto any
VO-compliant portal.  Creating an NVO Logon is not required to use most NVO
services; however, an NVO Logon will give you access to enhanced services such
as remote storage and access to proprietary data.
</p>

<dl>
<dt>Creating an NVO Logon is a two step process. <p>
...
NVO-compliant portal.  Please see the VO-compliant portal's documentation 
for instructions for how to enable your NVO logon with that portal.  
</p>

<p>
A password must be at least 6 characters long and should follow 
<a href="/aboutNVOLogons/GoodPasswords.html" 
   onclick="popupHelp('/aboutNVOLogons/GoodPasswords.html'); return false">good 
...
<% } %>
	 ...
	 <td valign="top"><font color="red">*</font></td>
	 <td><a href="/aboutNVOLogons/GoodPasswords.html"
		onclick="popupHelp('/aboutNVOLogons/GoodPasswords.html'); return false">Choose a
		password</a>:</td>
...
<% } %>
	 ...
	 <td valign="top">
	   <a href="/aboutNVOLogons/GoodPasswords.html" 
	      onclick="popupHelp('/aboutNVOLogons/GoodPasswords.html'); return false">Repeat 
	      the password</a>:</td>
