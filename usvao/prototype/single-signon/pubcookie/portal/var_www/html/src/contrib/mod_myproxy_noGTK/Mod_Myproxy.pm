...
use CP_ROOT => undef; # define this
use CLASSPATH => "$CP_ROOT:$CP_ROOT/bcprov.jar:$CP_ROOT/cog-jglobus.jar:$CP_ROOT/cryptix32.jar:$CP_ROOT/cryptix-asn1.jar:$CP_ROOT/jce-jdk13-125.jar:$CP_ROOT/jgss.jar:$CP_ROOT/puretls.jar";
use JAVA_LOCATION => "/usr/java/current/bin/java";
use MYPROXY_LOGON => "$CP_ROOT/MyProxyLogon";
