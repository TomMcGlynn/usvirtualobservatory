...
#define PBC_MAX_HARD_EXPIRE 	( 2 * 7 * 24 * 60 * 60 + 60 * 60 ) /* two weeks plus an hour */
#define PBC_DEFAULT_HARD_EXPIRE  ( 7 * 24 * 60 * 60 ) /* one week */
#define PBC_DEFAULT_EXPIRE_LOGIN ( 7 * 24 * 60 * 60 )
