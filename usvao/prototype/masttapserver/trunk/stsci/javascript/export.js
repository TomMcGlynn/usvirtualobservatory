/**
 * A collection of functions for exporting table data to a file or to
 * a VO service.
 */
...
function renderXML() {
   ...
   form.action = "@CGI_PATH@votable2xml.pl";
   try {
...
/**
 * Remove attributes from TD elements in votable. In particular,
 * remove the val attributes. 
 */
