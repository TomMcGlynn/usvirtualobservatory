...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
 ...
 exclude-result-prefixes="vo v1 v2 v3 v4" version="1.0">
	...
	<!--
	<xsl:variable name="filterRows" select="$allRows[TD[7]&gt;0 and TD[8]&gt;0.2]"/>
	<xsl:variable name="filterRows0" select="$allRows0[vo:TD[7]&gt;0 and vo:TD[8]&gt;0.2]"/>
	<xsl:variable name="filterRows1" select="$allRows1[v1:TD[7]&gt;0 and v1:TD[8]&gt;0.2]"/>
	<xsl:variable name="filterRows2" select="$allRows2[v2:TD[7]&gt;0 and v2:TD[8]&gt;0.2]"/>
	<xsl:variable name="filterRows3" select="$allRows3[v3:TD[7]&gt;0 and v3:TD[8]&gt;0.2]"/>
	<xsl:variable name="filterRows4" select="$allRows4[v4:TD[7]&gt;0 and v4:TD[8]&gt;0.2]"/>
	--> 
