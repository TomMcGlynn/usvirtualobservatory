...
public class FilterTests extends SeleneseTestCase {
	...
	protected void FilterTestProcedure() throws Exception {
		...
		selenium.open("/voview-propose/vo/develop/view/filter_test.html");
		...
		selenium.open("/voview-propose/vo/develop/view/filter_test2.html");
	...
	private class VotableParseCallBack extends DefaultHandler {
		public void startElement(String uri, String localName, String qName,
			...
			if (qName.equals("PARAM")) {
				if (attrib.getValue("name")!=null && attrib.getValue("name").equals("VOV:TotalCount")) {
					TotalCountParam = Integer.parseInt( attrib.getValue("value") );
				}
				if (attrib.getValue("name")!=null && attrib.getValue("name").equals("VOV:FilterCount")) {
