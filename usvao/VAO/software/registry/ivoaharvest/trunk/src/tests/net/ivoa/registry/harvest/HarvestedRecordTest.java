...
public class HarvestedRecordTest {
    ...
    static final String tmppath = System.getProperty("test.tmpdir");

    Reader openTestRec() {
        return new InputStreamReader(getClass().getResourceAsStream(testrec));
    }
    ...
    @Test public void testWriteContent() {
        Reader r = openTestRec();
        assertNotNull(r);
        HarvestedRecord rec = new HarvestedRecord("ivo://goob", "2013", r);

        assertNotNull(tmppath, "test.tmpdir sys property not set");
