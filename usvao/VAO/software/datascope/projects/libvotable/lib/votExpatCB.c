 ...
 *  @date       8/03/09
 *
 *  @brief      (Internal) Expat parser XML callback methods
 */
 ...
 *  
 *  @brief  CB whenever a start tag is seen (internal method)
 ...
 *
 *  @brief  CB whenever an end tag is seen (internal method)
 ...
 *
 *  @brief  Handle non-element character strings (internal method)
 ...
 *
 *  @brief  Compile a table of strings for easy access (internal method)
