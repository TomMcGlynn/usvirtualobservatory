 ...
 *  @date       8/03/09
 *
 *  @brief      (Internal) Methods to manage interface handles.
 */
...
/** 
 *  vot_handleCount -- Get the number of handle_t used (internal method)
 *
 *  @brief  Get the number of handle_t used (internal method)
 ...
 *
 *  @brief  Lookup the handle_t to an Element (internal method)
 ...
 *
 *  @brief  Assign the Element a handle_t (internal method)
...
vot_setHandle (Element *elem)
{
    ...
    */
    fprintf (stderr, "ERROR: Handle overflow.");
    return (0);
}
 ...
 * 
 *  @brief  Free a handle for use (internal method)
 ...
 *  
 *  @brief Get the Element refered to by handle_t (internal method)
 ...
 *
 *  @brief  Free all the handle nodes (internal method)
 ...
 *
 *  @brief  Initialize a handle table (internal method)
