...
public class Header {
   ...
   public  Header() {
      ...
      addToken(Settings.get("Portal"), "NVO Home");
//      addToken("http://heasarc.gsfc.nasa.gov/vo/portal/", "Portal Home");
   }
   ...
   */
   ...
   public void printBanner(PrintStream out) {
      addToken("http://www.us-vo.org/dev/help/contact.cfm", "Contact Us");
      ...
      out.println(
         ...
         "<img src='http://www.us-vo.org/images/NVO_100pixels.jpg' alt='NVO Logo' /></a>\n" +
         "<br />\n" +
         "<span class='nvolink'><a href='http://www.us-vo.org/'>National Virtual Observatory</a></span><br />\n" +
         "</td>\n" +
	 icon +
   ...
   public void printHTMLHeader(PrintStream out) {
      ...
      addCSSFile(Settings.get("docbase","")+Settings.get("CSS_PATH","css/")+"net_nvo.css");   // add the net_nvo.css, but don't forget to copy it in
//      addCSSFile("@URL_PATH@@CSS_PATH@net_nvo.css");   // add the net_nvo.css, but don't forget to copy it in
