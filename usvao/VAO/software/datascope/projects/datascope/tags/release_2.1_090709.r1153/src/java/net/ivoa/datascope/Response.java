...
public class Response {
	...
	Settings.put("skipRegCache",  ""+skipRegCache);
	...
	//	hdr.addToken("http://us-vo.org/feedback/", "Contact Us", "Send mail to the NVO team");
	...
	try {
	    SettingsFilter.filter(Settings.get("urlprefix")+Settings.get("docBase")+"responsebody.html", true);
	} catch(Exception e) {
	    e.printStackTrace(System.out);
	    new ShowError("DataScope").fail("Missing/Invalid response template", e);
	}
    }
