...
public class Cone extends Service {
    ...
    /** The class counts the number of rows in each table
     *  in the VOTable.  It just looks for <TR>'s and saves
     *  the result when it comes to the end of the <RESOURCE>.
     *  Tables without rows are ignored.
     */
    private class ConeCallBack extends DefaultHandler {
