...
public final class DS {
    ...
    private static  String DataHome     = "/www/htdocs/vo/data/";
...
//    private static  int     minPurgeTime = 300000; // 5 minutes
    ...
    private static  String   RegistryURL="http://nvo.stsci.edu/vor10/ristandardservice.asmx/TestKeywords";
    private static  String[] RegistryQuery= new String[] {
	    "keywords=SimpleImageAccess&from=&max=",
        "keywords=ConeSearch&from=&max="
    };
    
    private static  String[] RegistryTranslators= new String[] {
	    "sia.xsl",
        "cone.xsl"
    };
   ...
   /** Base of CGI scripts (as a file)  */
	...
	if (!minPurgeUpd) {
		...
		minPurgeTime = parseInt(Settings.get("MinPurgeTime"), minPurgeTime);
	    }
	    minPurgeUpd = true;
	}
    ...
    /** An amount to add to the filter to accommodate the intrinsic sizes of
	...
	try {
            logWriter = new java.io.PrintWriter(new java.io.FileWriter(dir+"/processing.log"));
	} catch (Exception e) {
