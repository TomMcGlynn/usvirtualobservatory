...
public class Scanner {
	...
	try {
        ...
        Map<String, Map<String, List<String>>> xresults =
	...
	try {
	    results = RegistryQuery.query(
	      Settings.getArray("RegistryURLs"),
	      Settings.getArray("RegistryXSLs"));
	} catch (Exception e) {
	...
	for (String id: results.keySet()) {
		...
		if (!sn.equals(nsn)) {
		    List snList = new ArrayList<String>();
		    snList.add(nsn);
		    result.put("ShortName", snList);
		    sn = nsn;
		}
	    }
