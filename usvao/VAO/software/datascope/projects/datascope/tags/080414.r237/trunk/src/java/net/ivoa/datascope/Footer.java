...
public class Footer {
	...
	addElement(
     "<table width='100%' border=0><tr>" +
       "<td align=center><a href=http://www.nsf.gov><img src="+DS.getURLBase()+"/images/nsflogo_64x.gif width=64 height=64 border=0 alt='NSF Home'></a></div></td>" +
       "<td align=center><a href=http://www.nasa.gov><img src="+DS.getURLBase()+"/images/nasa_logo.gif width=72 height=60 border=0 alt='NASA home'></a></td>"+
       ...
       "<td align=center><a href=http://www.ivoa.net><img src="+DS.getURLBase()+"/images/IVOAlogo.gif width=80 height=44 border=0 alt='IVOA Home'></a></td>"+
      "</tr></table>");
	addElement(
