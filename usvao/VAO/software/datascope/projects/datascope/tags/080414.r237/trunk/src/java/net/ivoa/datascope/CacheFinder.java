...
public class CacheFinder {
    ...
    /** The name fo the cache directory */
    private String name;
    ...
    /** Locate */
    public CacheFinder(double ra, double dec, double rad, boolean needNew) throws Exception {
	
	name           = DS.getCacheHome() + File.separator  + ""+ra+"_"+dec+"_"+rad + File.separator;
