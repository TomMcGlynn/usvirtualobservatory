...
public final class DS {
	...
	private static String RegistryURL = "http://nvo.stsci.edu/vor10/NVORegInt.asmx/VOTKeyword";
	private static String[] RegistryQuery = new String[] {
			"keywords=SimpleImageAccess&andKeys=true",
			"keywords=ConeSearch&andKeys=true" };
