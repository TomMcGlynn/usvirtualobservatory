...
public class Scanner {
	...
	public void setup(double ra, double dec, double size) {
		...
		for (String id : results.keySet()) {
			...
			String url = getScalar("accessURL");
			String sn = getScalar("shortName");
			String rorS = getScalar("regionOfRegard");
			String maxRS = getScalar("maxRadius");
			String type = getScalar("capabilityClass");
		...
		try {
			...
			for (Service s : services) {
				...
				String line = getScalar("shortName") + '|' + getScalar("title")
						+ '|' + getScalar("capabilityClass") + '|'
						+ getScalar("publisher") + '|' + getArr("type") + '|'
						+ getArr("subject") + '|' + getArr("waveband")
