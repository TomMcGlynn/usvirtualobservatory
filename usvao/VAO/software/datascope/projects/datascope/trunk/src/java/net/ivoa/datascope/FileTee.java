...
public class FileTee {
	...
	public void run(String sn, String id, String index, String cache,
			String type, String column) throws Exception {
		...
		if (f != null) {
			...
			String url = new FieldExtractor().find(cache + sn + "." + id
					+ ".xml", row, col);
			if (url == null) {
	...
	private void locationThenCopy(String url, String filename, String dftType)
			throws Exception {
	...
	private void transmitThenSave(String url, String filename, String dftType)
			throws Exception {
