...
sub new {
	...
	$self->{javaCommand} = 
		"/usr1/local/java/bin/java -Xmx500M net.ivoa.datascope.Response";
#	$self->{javaCommand} = 
#		"/usr1/local/java/bin/java -Xmx500M -Xdebug -Xrunjdwp:transport=dt_socket,address=1044,server=y,suspend=y net.ivoa.datascope.Response";
