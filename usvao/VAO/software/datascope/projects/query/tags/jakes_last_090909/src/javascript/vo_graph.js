function renderGraph() {
   try {
      ...
      top.twin.document.write("<head><title>Flot Graph</title>\n" +
         "<link rel='StyleSheet' href='@URL_PATH@@CSS_PATH@vo_graph.css' type='text/css'>\n" +
         "<script language='javascript' type='text/javascript' src='@URL_PATH@@JS_PATH@sarissa.js'></script>\n" +
         "<script language='javascript' type='text/javascript' src='@URL_PATH@@JS_PATH@jquery.js'></script>\n" +
         "<script language='javascript' type='text/javascript' src='@URL_PATH@@JS_PATH@jquery.flot.js'></script>\n" +
         "<script language='javascript' type='text/javascript' src='@URL_PATH@@JS_PATH@jquery.vo.graph.js'></script>\n" +
         "<!--[if IE]><script language='javascript' type='text/javascript' src='@URL_PATH@@JS_PATH@excanvas.pack.js'></script><![endif]-->\n" +
