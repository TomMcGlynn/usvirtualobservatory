...
public class Querier {   
   ...
   void run(String startupJS, String templateSetting, CGI cgi) throws Exception {
      ...
      hdr.addCSSFile(Settings.get("CSS_PATH","css/")+"style.css");
      hdr.addCSSFile(Settings.get("CSS_PATH","css/")+"net_nvo.css");
      hdr.addCSSFile(Settings.get("CSS_PATH","css/")+"voview.css");
      hdr.addJavaScript(Settings.get("JS_PATH","js/")+"sarissa.js");
      hdr.addJavaScript(Settings.get("JS_PATH","js/")+"cookie.js");
      hdr.addJavaScript(Settings.get("JS_PATH","js/")+startupJS);
      hdr.addJavaScript(Settings.get("JS_PATH","js/")+"jquery.pack.js");
      hdr.addJavaScript(Settings.get("JS_PATH","js/")+"jquery.vo.convert.js");
      hdr.addJavaScript(Settings.get("JS_PATH","js/")+"jquery.simplemodal.js");
      hdr.addJavaScript(Settings.get("JS_PATH","js/")+"vo_graph.js");
      hdr.addJavaScript(Settings.get("JS_PATH","js/")+"statemanager.js");
      hdr.addJavaScript(Settings.get("JS_PATH","js/")+"query.js");
      hdr.addJavaScript(Settings.get("JS_PATH","js/")+"filter.js");
      hdr.addJavaScript(Settings.get("JS_PATH","js/")+"fsm.js");
      hdr.addJavaScript(Settings.get("JS_PATH","js/")+"voview.js");
      hdr.addJavaScript(Settings.get("JS_PATH","js/")+"tablednd.js");
//      hdr.addJavaScript(Settings.get("JS_PATH","js/")+"voformatter.js");
      hdr.addJavaScript(Settings.get("JS_PATH","js/")+"export.js");
      ...
      */
      ...
      SettingsFilter.filter(Settings.get("URLAbs") + Settings.get(templateSetting), true); // 'true' deletes lines where the matching variable value is ""
...
//      System.out.println( "<input type='hidden' name='units'         value='arcsec' />" );     // for Inventory
      ...
      System.out.println( "<input type='hidden' name='referralURL'   value='http://heasarc.gsfc.nasa.gov"+Settings.get("cgibase","")+"/query.pl'/>" );
