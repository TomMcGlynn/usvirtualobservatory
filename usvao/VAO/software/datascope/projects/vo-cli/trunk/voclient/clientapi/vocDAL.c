	...
	double dec_size, char *format)
{
    ...
    bzero (pos,  SZ_PBUF);			/* clear arrays 	*/
    bzero (size, SZ_PBUF);
    bzero (fmt,  SZ_PBUF);
...
voc_executeCSV (Query query)
{
    ...
    char      *raw = NULL, *csv = NULL, *rp = NULL;
	...
	bzero (errmsg, SZ_ERRMSG);
	strcpy (errmsg, msg_getBuffer (result));
    } else
...
voc_executeTSV (Query query)
{
    ...
    char      *raw = NULL, *tsv = NULL, *rp = NULL;
...
voc_executeASCII (Query query)
{
    ...
    char      *raw = NULL, *ascii = NULL, *rp = NULL;
...
voc_executeVOTable (Query query)
{
    ...
    char      *raw = NULL, *vot = NULL, *rp = NULL;
