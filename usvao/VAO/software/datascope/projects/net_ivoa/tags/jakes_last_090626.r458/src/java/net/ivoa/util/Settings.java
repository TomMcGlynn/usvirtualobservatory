...
/** This class defines a singleton where preferences/settings
   ...
   */
   ...
   public static String get(String key, String dft) {
      ...
      if (gt == null) {
         ...
         //	return single.get(key.toLowerCase()).replaceAll("/+","/").replace("/$","");
...
// This should probably be made application and key specific
   ...
   * Returns a 0 length array if the value is not set.
   */
