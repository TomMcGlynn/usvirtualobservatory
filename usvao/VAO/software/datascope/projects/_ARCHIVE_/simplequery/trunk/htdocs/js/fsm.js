var activecount = 0;    // Number of outstanding download requests.
...
function makeRequest(http_request, 
                     url, 
		     parameters, 
		     doneCallback,
		     processingCallback,
    ...
    http_request.onreadystatechange = function() {
	    ...
	    if (processingCallback) {
		    ...
		    if (http_request.responseText.length == 0) {
		        errmsg("No information returned.");
		    } else {
                        errmsg("Response is not XML.");
		    }
                }
...
FSMLoader.prototype.actionTransitionFunctions = 
	...
	Update:
	    function(event) { return this.currentState; },
