 ...
 * query = dal_getAccessDataQuery (dal)
 *
...
/*
 * dal_getSiapQuery -- Get a Query object for a Siap (image) service.
 *
...
/*
 * dal_getSsapQuery -- Get a Query object for a Ssap (spectrum) service.
 *
