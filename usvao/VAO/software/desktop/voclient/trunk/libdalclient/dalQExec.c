...
/* dal_getQueryResponse -- Get the QueryResponse object for an already executed query.
 *
...
/* dal_closeQueryResponse -- Close a QueryResponse object and free all resources.
 *
 ...
 * @fn	    qr = dal_executeVOTable (query)
 *
 * @param   query		Query object handle
