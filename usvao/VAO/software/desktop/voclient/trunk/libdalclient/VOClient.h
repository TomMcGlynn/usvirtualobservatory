...
Query dal_getAccessDataQuery (DAL dal);
...
int dal_accessData (Query query, char *fname);
...
#define voc_getAccessDataQuery		dal_getAccessDataQuery
...
#define voc_accessData			dal_accessData
