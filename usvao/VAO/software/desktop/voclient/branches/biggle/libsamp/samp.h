...
extern int 	  samp_hubRunning (void);
extern int 	  samp_hubInit (handle_t samp, char *appName, char *descr);

extern int	  samp_processHubEvent (String mtype, Map params);
extern int	  samp_hubEvent (String mtype);

extern int 	  samp_hubRegister (Hub *hub);
extern int 	  samp_hubUnRegister (Hub *hub);
extern int 	  samp_hubSendShutdown (Hub *hub);
