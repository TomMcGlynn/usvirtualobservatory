...
extern int vot_simpleGetURL(char *url, char *ofname);
...
extern handle_t  vot_getChildOfType (handle_t elem_h, int type);
...
extern void      vot_writeVOTable (handle_t node, char *fd, int indent);
