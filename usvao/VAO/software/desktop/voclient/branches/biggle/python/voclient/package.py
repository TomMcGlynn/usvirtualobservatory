...
class VOTask:
	...
	def executeSync (self):
		...
		:raises VOTaskParameterError: thrown when parameters are invalid
		:raises VOTaskExecutionError: thrown when there is an error is executing a task, e.g. a segfault.
