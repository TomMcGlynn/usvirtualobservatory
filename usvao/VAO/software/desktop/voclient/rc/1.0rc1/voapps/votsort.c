...
static Task  self       = {  "votsort",  votsort };
static char  *opts 	= "c:df:hiLnN:I:U:o:rst:";
...
votsort (int argc, char **argv, size_t *reslen, void **result)
{
    ...
    int    i = 0, ch = 0, status = OK, pos = 0, col = 0, do_string = 0;
    ...
    */
    ...
    /*  Sort the table.
     */
    (void) vot_sortTable (tdata, col, do_string, sort_order);
