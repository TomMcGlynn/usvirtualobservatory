...
Tests (char *input)
{
   ...
   vo_taskTest (self, "-n", mef, NULL);		/* examples */
   vo_taskTest (self, "-b", "-s", sif, NULL);
   vo_taskTest (self, "-c", sif, NULL);

   vo_taskTest (self, "-a", sif, NULL);
   vo_taskTest (self, "-i", sif, NULL);
   vo_taskTest (self, "-b", sif, NULL);
   vo_taskTest (self, "-c", sif, NULL);
   vo_taskTest (self, "-n", sif, NULL);
   vo_taskTest (self, "-s", sif, NULL);
}
