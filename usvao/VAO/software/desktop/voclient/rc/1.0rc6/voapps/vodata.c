...
static struct option long_opts[] = {
    ...
    { "verbose",  1, &mf, 14 },		/* req'd arg word		*/
    ...
    { "extract",  2, &mf, 20 },		/* opt arg word			*/
    { "ep",       2, &mf, 20 },		/* opt arg word			*/
    { "eu",       2, &mf, 20 },		/* opt arg word			*/
    { "eh",       2, &mf, 20 },		/* opt arg word			*/
    { "ek",       2, &mf, 20 },		/* opt arg word			*/
    { "eK",       2, &mf, 20 },		/* opt arg word			*/
    { "get",      2, &mf, 21 },		/* opt arg word			*/
    { "hskip",    2, &mf, 22 },		/* opt arg word			*/

    { "proxy",    0, &mf, 25 },		/* no arg word			*/
    { "vverbose", 0, &mf, 26 },		/* no arg word			*/
