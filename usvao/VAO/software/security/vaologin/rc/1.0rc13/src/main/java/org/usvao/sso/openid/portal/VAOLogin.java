 ...
 * {@link org.usvao.sso.openid.portal.spring.SSFOpenIDLogin SSFOpenIDLogin} 
 * class assumes that the Spring Security Framework was used to manage the 
 * OpenID authentication.  
 * <p> 
 * The {@link #getAttribute(String) getAttribute()} and 
 * {@link #getAttributeValues(String) getAttributeValues()} provide 
 ...
 * {@link USVAOConventions} enum {@link USVAOConventions.SupportedAttribute} 
 * (e.g. {@link #getEmail()}, etc.).  For the default implementations to work,
