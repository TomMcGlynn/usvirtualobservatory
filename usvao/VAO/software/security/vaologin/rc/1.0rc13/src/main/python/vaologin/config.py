...
def getDefaultHomeDir():
    """
    return a value to serve as a default home directory for vaologin.
    If the VAOLOGIN_HOME is set, that will be returned.  Otherwise,
    the value of def_product_home will be returned.  
    """
    if os.environ.get(vaologin_home_envvar):
