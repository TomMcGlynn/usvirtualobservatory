...
public class TemplateTags {
    ...
    // data & attributes
    public static final String TAG_NAME = AxPrefsKit.KEY_NAME; // user's name (or username if not available)
    public static final String TAG_USERNAME = AxPrefsKit.KEY_USERNAME; // NVO ID (username)
    public static final String TAG_PASSWORD = "password"; // NVO ID password
    public static final String TAG_EMAIL = AxPrefsKit.KEY_EMAIL;
    public static final String TAG_PHONE = AxPrefsKit.KEY_PHONE;
    public static final String TAG_INSTITUTION = AxPrefsKit.KEY_INSTITUTION;
    public static final String TAG_COUNTRY = AxPrefsKit.KEY_COUNTRY;
    public static final String TAG_SSO = AxPrefsKit.KEY_SSO; // Single sign-on
    public static final String TAG_CREDENTIAL = AxPrefsKit.KEY_CREDENTIAL; // credential
    ...
    public static Map<String, String> populateUserTags(NvoUser user, Map<String, String> map) {
        ...
        map.put(TAG_CREDENTIAL, "NVO credential for " + user.getName());
        return map;
    }
}
