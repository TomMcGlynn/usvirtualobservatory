...
public class AxPrefsKit {
    ...
    public static final String DESC_EMAIL = "email address", DESC_NAME = "name",
            DESC_USERNAME = "NVO login ID (username)", DESC_PHONE = "phone number",
            DESC_CREDENTIAL = "NVO security credential",
    ...
    public static String getAttributeValue(String axKey, NvoUser user) {
        ...
        else if (KEY_USERNAME.equals(axKey)) return user == null ? "an NVO ID" : user.getUserName();
