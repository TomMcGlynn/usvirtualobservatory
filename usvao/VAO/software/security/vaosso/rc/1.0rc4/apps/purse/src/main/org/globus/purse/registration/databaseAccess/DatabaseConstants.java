...
public class DatabaseConstants {
    ...
    // User table
    static String USER_TABLE_NAME = null;
    static String USER_COL_ID = null;
    static String USER_COL_TOKEN = null;
    static String USER_COL_FIRST_NAME = null;
    static String USER_COL_LAST_NAME = null;
    static String USER_COL_CONTACT_PERSON = null;
    static String USER_COL_STMT_WORK = null;
    static String USER_COL_USER_NAME = null;
    static String USER_COL_PASSWORD_SHA1 = null;
    static String USER_COL_INSTITUTION = null;
    static String USER_COL_PROJECT_NAME = null;
    static String USER_COL_EMAIL = null;
    static String USER_COL_PHONE = null;
    static String USER_COL_COUNTRY = null;
    static String USER_COL_DN = null;
    static String USER_COL_STATUS = null;
    static String USER_COL_RA_ID = null;
    static String USER_COL_CREATION = null;
    static String USER_COL_LAST_ACCESS = null;
    static String USER_COL_NUM_LOGINS = null;
    static String USER_COL_PORTAL_CONFIRM_URL = null;
    static String USER_COL_PORTAL_NAME = null;

    // RA Table
    static String RA_TABLE_NAME = null;
    static String RA_COL_ID = null;
    static String RA_COL_EMAIL_ID = null;
    static String RA_COL_NAME = null;
    static String RA_COL_DESC = null;

    // Role Table 
    static String ROLE_TABLE_NAME = null;
    static String ROLE_COL_ID = null;
    static String ROLE_COL_NAME = null;
    static String ROLE_COL_DESC = null;

    // User role table 
    static String USER_ROLE_TABLE_NAME = null;
    static String USER_ROLE_ROLE_ID = null;
    static String USER_ROLE_USER_ID = null;

    // Status Table constants
    static String STATUS_TABLE_NAME = null;
    static String STATUS_COL_ID = null;
    static String STATUS_COL_NAME = null;
    static String STATUS_COL_DESC = null;

    // Group table
    static String GROUP_TABLE_NAME = null;
    static String GROUP_COL_ID = null;
    static String GROUP_COL_NAME = null;
    static String GROUP_COL_DESC = null;

    // User-group
    static String USER_GROUP_TABLE_NAME = null;
    static String USER_GROUP_USER_ID = null;
    static String USER_GROUP_GROUP_ID = null;
	...
	USER_COL_PASSWORD_SHA1 = (String)prop.getProperty("password_sha1");
	...
	if (!(validateString(USER_TABLE_NAME) || 
	      ...
	      validateString(USER_COL_PASSWORD_SHA1) || 
