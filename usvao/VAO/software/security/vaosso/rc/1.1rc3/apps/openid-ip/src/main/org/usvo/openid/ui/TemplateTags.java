...
public class TemplateTags {
    ...
    public static final String TAG_EXTRA_METAS = "extraMetas"; // inside start of head
    ...
    public static final String TAG_CHANGEUSER = "changeuser"; // link for switching user
