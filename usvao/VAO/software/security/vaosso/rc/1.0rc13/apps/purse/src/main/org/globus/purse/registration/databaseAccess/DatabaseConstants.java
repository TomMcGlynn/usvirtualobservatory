...
public class DatabaseConstants {
    ...
    public static String USER_COL_CREATED_FROM_ADDR = null;
	...
	USER_COL_CREATED_FROM_ADDR = 
            (String)prop.getProperty("created_from_addr");
	...
	if (!(validateString(USER_TABLE_NAME) || 
	      ...
	      validateString(USER_COL_CREATED_FROM_ADDR) ||
