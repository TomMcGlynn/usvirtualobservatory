...
public class PreferencesPage {
    ...
    private void setPortalFilter(HttpServletRequest request) {
        String defsel = Conf.get().read().get("prefs.default_portal_listing");
    ...
    public String handleUpdate(NvoUser foruser) {
        ...
        for(String pref : prefvals.keySet()) {
            ...
            if (newp != null && (newp.booleanValue() || oldp != null)) 
    ...
    static final String PARAM_SHARE_USERNAME = "share_username";
    static final String PARAM_SHARE_NAME = "share_name";
    static final String PARAM_SHARE_EMAIL = "share_email";
    static final String PARAM_SHARE_INSTITUTION = "share_institution";
    static final String PARAM_SHARE_PHONE = "share_phone";
    static final String PARAM_SHARE_COUNTRY = "share_country";
    static final String PARAM_SHARE_CREDS = "share_creds";
    static final String PARAM_ALWAYS_CONFIRM = "alwaysconfirm";
    ...
    static final String[] EXTRA_SCRIPT_NAMES = { "prefsform.js" };
