...
e);
    ...
    public static void main(String[] args) {
        if (args.length == 0) {
            System.err.println("Missing value to hash");
            System.exit(1);
        }
        String salt = "cea17d";
        ...
        try {
            String[] hashed = UserDataHandler.passwordSha(args[0], salt);
            System.out.append(hashed[0]).append(' ').append(hashed[1])
                      .append(' ').append(hashed[2]).append("\n");
