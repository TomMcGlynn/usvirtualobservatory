...
public class UserData {
    ...
    String createdFromAddr = null;
    String userName = null;
    String passwordSha = null;
    String salt = null;
    String passwordMethod = null;
     ...
     * @param createdFromAddr Statement of work
     * @param userName User name used to log onto ESG portal/MyProxy server
     * @param passwordSha Password used to log onto ESG portal/MyProxy server
     * @param salt Password salt
     * @param passwordMethod Password method
    ...
    public UserData(String firstName, String lastName, String contactPerson,
		    String createdFromAddr, String userName, String passwordSha,
                    String salt, String passwordMethod,
	...
	throws UserRegistrationException {
        this(-1, firstName, lastName, contactPerson, createdFromAddr, userName,
	     passwordSha, salt, passwordMethod, institution, projectName, emailAddress, phone, country, null,
    ...
    public UserData(int userId, String firstName, String lastName,
		    String contactPerson, String createdFromAddr, String userName,
		    String passwordSha, String salt, String passwordMethod, String institution, String projectName,
	...
	throws UserRegistrationException {
        ...
        this.createdFromAddr = validateString(createdFromAddr, "Statement of work", false);
        this.userName = validateString(userName, "User name");
        this.passwordSha = passwordSha; // can't use setPassword() in case old passwords fail new, stricter validation
        this.salt = salt;
    ...
    /** Statement of work  */
    public String getCreatedFromAddr() {
	    return this.createdFromAddr;
    }
    ...
    public boolean equals(UserData userData) {
        ...
        if (!RegisterUtil.stringsMatch(this.createdFromAddr,
                userData.getCreatedFromAddr()))
            return false;
        logger.debug("created-from-address thro'");

        if (!RegisterUtil.stringsMatch(this.userName, userData.getUserName()))
            return false;
        logger.debug("userName tho'");

        if (!RegisterUtil.stringsMatch(this.passwordSha, userData.getPasswordSha()))
            return false;
        logger.debug("password tho'");

        if (!RegisterUtil.stringsMatch(this.salt, userData.getSalt()))
            return false;
        logger.debug("password_salt tho'");

        if (!RegisterUtil.stringsMatch(this.passwordMethod, userData.getPasswordMethod()))
            return false;
        logger.debug("password_method tho'");
