...
public class LoginUI {
    ...
    public void displayLoginForm() throws IOException, OpenIDException {
        ...
        {
            returnto.append("?returnURL=").append(_referer);
            String pname = map.get(TemplateTags.TAG_RELYING_NAME);
            if (pname != null && pname.length() > 0)
                returnto.append("&portalName=").append(URLEncoder.encode(pname));
        }
            ...
            throws OpenIDException, IOException
    {
        ...
        if (approved)
            ...
            buf.append("This portal is not recognized as a ")
        ...
        if (Compare.isBlank(requestedUsername))
            map.put(TemplateTags.TAG_CHOICE_LOGOUT, 
                    TemplatePage.substitute(TemplateTags.SNIPPET_CHOICE_LOGOUT, map));
        ...
        throws IOException
    {
        ...
        if (atts == null || atts.size() == 0) {
            ...
            desc.append("<p>\nThis portal requests information about its ");
            desc.append("users:  it ");
            ...
            desc.append("\n</p>\n\n<p>Would you like to trust this portal ")
                .append("and share your information with it?</p>\n");
        }
    ...
    public String getReturnUrl(boolean trim) {
        ...
        String result = params.getParameterValue(OpenIdConstants.RETURN_TO);
    ...
    public String describeReturnTo(Portal portal) {
        ...
        return ParseKit.trimUrl(result, true, true, true, true);
    }
    ...
    private String describePortal(String portal, String url, boolean approved) {
        ...
        if (portal == null) {
            ...
            tagval.append("the <em title=\"");
        else 
            tagval.append("the portal at <em title=\"");
