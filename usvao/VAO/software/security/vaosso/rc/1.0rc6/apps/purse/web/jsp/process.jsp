        ...
        if (confError == null) {
            ...
            try {
                UserData userData = new UserData(
                        ...
                        inps.getUserName(),
                        UserDataHandler.passwordSha1(inps.getPassword1()),
...
<% if (confError.equals("UnknownToken")) {%>
...
<% } else if (confError.equals("TokenMailAccess")) {%>
<div class="error_box"><p>
...
<% } else if (confError.equals("InternalProcess")) {%>
<div class="error_box"><p>
