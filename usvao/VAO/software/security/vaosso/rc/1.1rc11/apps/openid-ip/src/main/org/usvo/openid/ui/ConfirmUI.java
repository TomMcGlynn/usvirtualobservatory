...
public class ConfirmUI extends AuthUI {
    ...
    private static final String PROJECT = 
        Conf.get().getProperty("provider.name");  // "VAO"
    ...
    */
        ...
        throws OpenIDException, IOException
    {
        ...
        if (approved)
            buf.append("This portal is recognized as a ").append(PROJECT)
               .append("-collaborating website supporting ").append(PROJECT)
               .append(" logins");
        else 
            buf.append("This portal is <em>not</em> recognized as a ")
               .append(PROJECT).append("-collaborating website; nevertheless ")
               .append("it does support ").append(PROJECT).append(" logins.");
        ...
        throws IOException
    {
        ...
        if (atts == null || atts.size() == 0) {
            ...
            */
            ...
            if (approvedPortal) {
                desc.append("As <em>this is a known portal trusted by the ")
                    .append(PROJECT)
                    .append("</em>, sharing this information is recommended.");
            }
