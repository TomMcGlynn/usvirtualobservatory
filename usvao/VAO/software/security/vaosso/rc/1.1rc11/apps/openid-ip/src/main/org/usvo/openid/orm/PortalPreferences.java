...
public class PortalPreferences {
    ...
    /**
     * return the set of parameters names that preference/permissions are
     * stored under.  This can be used, for example, to list all of the 
     * permissions that have been set in this objects.  
     */
    public Set<String> paramNames() { return permits.keySet(); }
