...
<html>
<head>
<% String title = "Our User Registration Complete"; %>
...
<h1 class="top">Welcome, <%= fullname %>, to the Secured Side of the
Our Web</h1>

<p>
Congratulations!  Your Our Logon registration is complete.  
</p>

<p>
Your Our user name is <strong><%=username%></strong>.  You may use it to log
into any Our-compliant portal.  
</p>

<p>
You also have an OpenID:
<strong>https://sso.our.org/openid/id/<%=username%></strong>.  You
...
<% if (!isBlank(returnURL)) { %>
    ...
    where you may be redirected to log in to the Our Web with your new logon.
    </p>
<% } %>
...
<dl>
   ...
   <dd> Only enter your Our password into the Our Login Page on this
        official site, <strong>sso.our.org</strong>.  For more information, consult our
...
<p>
The Our can supply you and the Our-compliant portals you visit with a
...
certificate, the Our will obtain confirmation of your identity from a recognized
authority.
...
<a href="/contact.html">Our feedback page</a>.
</p> 
