...
public class LoginUI extends AuthUI {
            ...
            AuthnAttempt authn, String returnto, String label)
    {
        ...
        log.debug("Building Login page for local service");
    }
            ...
            AuthnAttempt authn, String returnto, Portal portal)
    {
        ...
        log.debug("Building Login page for portal");
    }
    ...
    private String getLoginFormUrl() {
        if (isForInternalLogin) log.debug("using return URL as action");
        return (isForInternalLogin ? getReturnURL(): Conf.get().getSigninUrl());
    }
}
