...
public class MessageComposerFactory {
    ...
    /** Composer for a password reminder email. */
    public MessageComposer getUsernameReminderComposer() throws MailAccessException {
        String template = mailOptions.getUsernameReminderFilename();
        return createDefaultMessageComposer(template, "Username-reminder");
    }
