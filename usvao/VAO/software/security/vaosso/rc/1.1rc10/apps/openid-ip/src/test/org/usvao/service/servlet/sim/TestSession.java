/*
 * Adapted from java.javax.servlet.http.HttpSession.java
 *
...
public class TestSession implements HttpSession {
    ...
    */
     ...
     *
     */
    public Enumeration getAttributeNames() { return new AttrEnum(); }
     ...
     *					invalidated session
     */
    public void removeAttribute(String name) { atts.remove(name); }
     ...
     *
     */
    public void invalidate() { atts.clear(); }
    ...
    class AttrEnum implements Enumeration<String> {
        private Iterator<String> iter = atts.keySet().iterator();

        @Override
        public boolean hasMoreElements() { return iter.hasNext(); }

        @Override 
        public String nextElement() { return iter.next(); }
    }
}
