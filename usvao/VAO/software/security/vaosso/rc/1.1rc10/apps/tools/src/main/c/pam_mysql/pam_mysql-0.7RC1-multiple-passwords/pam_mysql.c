...
#else
						syslog(LOG_AUTHPRIV | LOG_ERR, PAM_MYSQL_LOG_PREFIX "MySQL password scrambling not supported");
#endif
					} break;
...
syslog(LOG_AUTHPRIV | LOG_CRIT, PAM_MYSQL_LOG_PREFIX "comparison p vs h: %s %s", password, hashed);
