...
public class UserAttributes {
    ...
    public Attribute makeAttribute(String uri, String alias) {
        ...
        String desc = descriptions.get(type);
        if (type == LocalType.UNSUPPORTED) { 
            log.warn("Request for unsupported attribute: " + uri);
            desc += " (" + ((alias != null) ? alias : uri) + ")";
        }
    ...
    static {
        ...
        VAO.addSupport("http://openid.net/schema/namePerson/friendly", LocalType.USERNAME);
        ...
        VAO.addSupport("http://openid.net/schema/namePerson", LocalType.NAME);
        ...
        VAO.addSupport("http://axschema.org/namePerson/first", LocalType.FIRSTNAME);
        VAO.addSupport("http://openid.net/schema/namePerson/first", LocalType.FIRSTNAME);
        VAO.addSupport("http://sso.usvao.org/schema/namePerson/last", LocalType.LASTNAME);
        VAO.addSupport("http://openid.net/schema/namePerson/last", LocalType.LASTNAME);
        VAO.addSupport("http://axschema.org/namePerson/last", LocalType.LASTNAME);
        ...
        VAO.addSupport("http://openid.net/schema/contact/phone/default", LocalType.PHONE);
        ...
        VAO.addSupport("http://openid.net/schema/country", LocalType.COUNTRY);
        VAO.addSupport("http://openid.net/schema/country/home", LocalType.COUNTRY);
        VAO.addSupport("http://openid.net/schema/country/business", LocalType.COUNTRY);
    ...
    static final String PROJECT = Conf.get().getProperty("provider.name");
    ...
    static {
        ...
        descriptions.put(LocalType.USERNAME, PROJECT+" login ID (username)");
        ...
        descriptions.put(LocalType.INSTITUTION, "institution");
    ...
    static {
        ...
        shareparams.put(LocalType.CREDENTIAL, "share_credentials");
    }
}
