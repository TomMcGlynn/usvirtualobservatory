...
void voc_printImgInfo (iminfo im);
 ...
 */
void
voc_printImgInfo (iminfo im)
{
    printf ("Name: %s  nextns=%d  dims[%d]=%d %d %d\n", im.imname, im.nextend, 
	im.naxis, im.naxes[0], im.naxes[1], im.naxes[2]);
    printf ("  is_image = %d   is_table = %d   has_wcs = %d\n",
	im.is_image, im.is_table, im.has_wcs);
    printf ("  center: %g %g  ll: %g %g  ur: %g %g\n",
	im.cx, im.cy, im.lx, im.ly, im.ux, im.uy);
    printf ("  corners: %g %g  %g %g  %g %g  %g %g\n",
	im.xc[0], im.yc[0], im.xc[1], im.yc[1],
	im.xc[2], im.yc[2], im.xc[3], im.yc[3]);
    printf ("  crval: %g %g   crpix: %g %g\n",
	im.xrval, im.yrval, im.xrpix, im.yrpix); 
    printf ("  w/h: %g %g   radius: %g  rotang: %g\n",
