...
*/    
class VOTableWriter implements IWriter
{
    ...
    public void write(String filename, Object data) throws SedException
    {
        ...
        {
            throw new SedException ("Problem accessing, "+filename+".", fnfe);
        }

        this.write( outStream, data );
    }
    ...
    public void write(OutputStream outStream, Object data) throws SedException
    {
        ...
        try
        {
            ...
            throw new SedException ("Caught TransformerConfigurationException: " +
                       tce.getMessage(), tce);
        }
        ...
        {
            throw new SedException ("IOException occurred while printing VOTable to output stream", ioe);
        }
        catch (TransformerException te)
        {
            throw new SedException ("TransformerException occurred while transforming VOTable to file", te);
    ...
    */
    private void recursivePrint(VOElement[] voElems,
                 ...
                 VOSerializer voSer,
                 BufferedWriter out)
                throws IOException, TransformerException, SedException
    {
...
//                                    ((VOTableWrapper)_wrapper).nextTable();
            ...
            {
                throw new SedException ("recursivePrint: Unknown node type. Expected ELEMENT_NODE, recieved " +
