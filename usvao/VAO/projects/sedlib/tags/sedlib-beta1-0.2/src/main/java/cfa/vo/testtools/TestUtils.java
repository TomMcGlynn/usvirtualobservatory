...
*/	
public class TestUtils extends ITestUtils
{
    static TestUtils m_theOneAndOnly = null;
    ...
    static public TestUtils getTestUtils()
    {
	if ( m_theOneAndOnly == null )
	{
	    m_theOneAndOnly = new TestUtils();
	}
...
//	    String testToolDir = System.getProperties().getProperty( "TESTTOOLS_DIR" );
            URL testToolUrl = TestUtils.class.getResource("/test_tools");
