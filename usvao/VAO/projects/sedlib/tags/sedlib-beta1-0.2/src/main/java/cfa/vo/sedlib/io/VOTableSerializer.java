...
public class VOTableSerializer implements ISedSerializer
{
     ...
     */
    protected VOTableObject processSed(Sed sed) throws SedException
    {
     ...
     */
    private void addSegmentToTable( Segment segment, TableElement parent)
        throws SedException
    {
        VOElement group;
        ...
        if (segment.isSetTarget ())
        {
            ...
            group = this.addGroup (VOTableKeywords.TARGET, parent);
        ...
        if (segment.isSetChar ())
        {
            ...
            group = this.addGroup (VOTableKeywords.SEG_CHAR, parent);
        ...
        if (segment.isSetCoordSys ())
        {
            ...
            group = this.addGroup (VOTableKeywords.SEG_CS, parent);
        ...
        if (segment.isSetCuration ())
        {
            ...
            group = this.addGroup (VOTableKeywords.SEG_CURATION, parent);
        ...
        if (segment.isSetDataID ())
        {
            ...
            group = this.addGroup (VOTableKeywords.SEG_DATAID, parent);
        ...
        if (segment.isSetDerived ())
        {
            ...
            group = this.addGroup (VOTableKeywords.SEG_DD, parent);
     ...
     */
    private void addCharacterizationToTable (Characterization _char, VOElement parent)
        throws SedException
    {
        VOElement group;
        ...
        {
            group = this.addGroup (VOTableKeywords.SEG_CHAR_SPATIALAXIS, parent);
        ...
        {
            group = this.addGroup (VOTableKeywords.SEG_CHAR_TIMEAXIS, parent);
        ...
        if (_char.isSetSpectralAxis ())
        {
            ...
            group = this.addGroup (VOTableKeywords.SEG_CHAR_SPECTRALAXIS, parent);
        ...
        {
            group = this.addGroup (VOTableKeywords.SEG_CHAR_FLUXAXIS, parent);
        ...
        if (_char.isSetCharacterizationAxis ())
        {
            ...
            {
                group = this.addGroup (VOTableKeywords.SEG_CHAR_CHARAXIS, parent);
     ...
     */
    private void addCharacterizationAxisToTable (CharacterizationAxis charAxis, VOElement parent, int utype)
        throws SedException
    {
        Document document = parent.getOwnerDocument ();
        VOElement group;
...
;
        ...
        if (charAxis.isSetCoverage ())
        {
            ...
            group = this.addGroup (newUtype, parent);
     ...
     */
    private void addCoverageToTable (Coverage coverage, VOElement parent, int utype)
        throws SedException
    {
        VOElement group;
        int newUtype;
...
*/
        ...
        if (coverage.isSetLocation ())
        {
            ...
            if (location.isSetAccuracy ())
            {
                ...
                subGroup = this.addGroup (accUtype, group);
     ...
     */
    private void addAccuracyToTable (Accuracy accuracy, VOElement parent, int utype) throws SedException
    {
     ...
     */
    private void addSamplingPrecisionToTable (SamplingPrecision samplingPrecision, VOElement parent, int utype)
           throws SedException
    {
        VOElement group;
        int newUtype;
     ...
     */
    private void addCoordSysToTable (CoordSys coordSys, VOElement parent)
        throws SedException
    {
        Document document = parent.getOwnerDocument ();
        VOElement group;
     ...
     */
    private void addCoordFrameToTable (CoordFrame coordFrame, VOElement parent, int utype)
        throws SedException
    {
        int newUtype;
    ...
    private void addCurationToTable (Curation curation, VOElement parent)
    {
        ...
        if (curation.isSetContact ())
        {
            ...
            group = this.addGroup (VOTableKeywords.SEG_CURATION_CONTACT, parent);
     ...
     */
    private void addDerivedTable (DerivedData derived, VOElement parent) throws SedException
    {
        VOElement group;
        if (derived.isSetSNR ())
        ...
        if (derived.isSetRedshift ())
        {
            ...
            group = this.addGroup (VOTableKeywords.SEG_DD_REDSHIFT, parent);
            ...
            {
                VOElement subGroup = this.addGroup (VOTableKeywords.SEG_DD_REDSHIFT_ACC, group);
    ...
    /**
     * Add information from the custom params to the VOTable
     */
    private void addArrayOfParamsToTable (ArrayOfParam params, VOElement parent, int utype)
    {
        ...
        if (params.isSetParam ())
        {
            ...
            for (Param param : paramList)
                this.addSedParam (param, parent, utype); 
        }
    }
        ...
        throws SedException
    {
        ...
        if (newUtype == VOTableKeywords.INVALID_UTYPE)
            throw new SedException (function + ": Invalid utype created through merge. Merged types "+VOTableKeywords.getName (baseUtype) + ", " + VOTableKeywords.getName (suffixUtype));
     ...
     * 
     */
    private VOElement addGroup (int utype, VOElement parent)
    {
    	Document document = parent.getOwnerDocument ();
        VOElement group = (VOElement)document.createElement(VOTableKeywords._GROUP);
        group.setAttribute (VOTableKeywords._UTYPE, VOTableKeywords.getName (utype, this.namespace));
        return group;
     ...
     * 
     */
    private VOTablePointGroup extractData (ArrayOfGenPoint data, TableElement voTable)
       throws SedException
    {
    ...
    private SedStarTable addDataToTable (VOTablePointGroup pointsGroup, TableElement voTable)
    {
        ...
        pointsGroup.getDataColumns (fields, fieldIds);
        fieldArray = fields.toArray (fieldArray);
        fieldIdArray = fieldIds.toArray (fieldIdArray);
    ...
    private void processSedCoordData ( SedCoord axis,
                                  VOTablePointGroup pointsGroup,
                                  int row,
                                  int utype) throws SedException

    {
        Param param;
        int newUtype;
        String functionName = "processSedCoordData";
        VOTablePointGroup subgroup = pointsGroup.createGroup (utype);
        String colId;
        ...
        if (axis.isSetValue ())
        {
            ...
            {
                colId = this.baseId+this.refCount++;
                subgroup.addField (this.newField (param, newUtype), newUtype, colId);
            }
    ...
    private Field newField (Param param, int utype)
    {
    	...
    	if (param instanceof DoubleParam)
    		field = new Field ( param.getName(),
                             this.getParamUcd (param, utype),
                             ((DoubleParam)param).getUnit(),
                             VOTableKeywords.getName(utype, this.namespace));
     ...
     */
    private void overrideParamInfo (Segment segment) throws SedException
    {
