...
/*
        keywords[DATE] = "SED_DATE";
        keywords[NSEGMENTS] = "SED_NSEG";
        keywords[CREATOR] = "SED_CREA";
        keywords[CREATORDID] = "SEDCRDID";
        keywords[SPECTRALMINWAVELENGTH] = "SEDMINWV";
        keywords[SPECTRALMAXWAVELENGTH] = "SEDMAXWV";
*/
        keywords[TIMESI] = "TIMESDIM";
        keywords[SPECTRALSI] = "SPECSDIM";
        keywords[FLUXSI] = "FLUXSDIM";
/*
        keywords[TARGET] = "SED_TARG";
*/
