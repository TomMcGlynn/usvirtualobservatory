    ...
    extends Group
{
    ...
    {
        try { // this statement can't actually throw the exception, since it is passing a double[] array.
     ...
     *
     */
    public double[] getFluxAxisValues () throws SedInconsistentException, SedNoDataException
    {
        double []values = null;
     ...
     * SedNoDataException is returned.
     *
     * @return
     *    {@link String}
     *
     ...
     * a default value is used; for doubles its NaN for ints its zero.
     *
    ...
    public void setDataValues (Object values, int utype) throws SedInconsistentException
    {
        ...
        if (pointData == null)
            pointData = (ArrayOfPoint)this.createData ();
     ...
     * SedNoDataException is thrown.
     *
     * If the utype is not supported then a SedInconsistentException is thrown
     * @param utype
     *   int
     *
     * @return
    ...
    public void setDataInfo (Field field, String utype) throws SedInconsistentException, SedNoDataException
    {
        ...
        if (pointData == null)
            throw new SedNoDataException("No data found");
     ...
     *
     */
    public Param getMetaParam (String utype) throws SedException
    {
        int utypeEnum = Utypes.getUtypeFromString (utype);

        if (utypeEnum == Utypes.INVALID_UTYPE)
            throw new SedException ("The utype, "+utype+", is not supported. There is no parameter associated with this utype.");
     ...
     *
     */
    public Param getMetaParam (int utype) throws SedException
    {
     ...
     *
     * @return
     *   either null or List<? extends Param>.
     *   {@link Param}
     *
     * @throws SedException
     *
     */
    public List <? extends Param> getMetaParamList (String utype) throws SedException
    {
        int utypeEnum = Utypes.getUtypeFromString (utype);
     ...
     *
     */
    public List <? extends Param> getMetaParamList (int utype) throws SedException
    {
        ...
        try
        {
            switch (utype)
            {
                ...
                case Utypes.SEG_DATAID_CONTRIBUTOR:
                {
                    ...
                    if (params != null)
                    {
                        paramList = new ArrayList<TextParam> (params.size ());
                ...
                {
                    List<DoubleParam> paramList = null;
                    ...
                    if (charAxis != null)
                    {
                        ...
                        if (charAxis.size () > 1)
                            throw new SedException ("Multiple copies of the Characterization Axis found. It's ambiguous as to which param should be retrieved.");

                        if (charAxis.size () > 0)
                        {
                            params = charAxis.get (0).getCoverage ().getLocation ().getValue ();
                            paramList = new ArrayList<DoubleParam> (params.length);
                ...
                break;
                default:
                    throw new SedException ("Cannot find a parameter associated with the specified utype, "+Utypes.getName (utype)+".");
            }
        }
     ...
     *
     */
    public void setMetaParam (Param param, String utype) throws SedException
     ...
     *
     */
    public void setMetaParam (Param param, int utype) throws SedException
    {
     ...
     */
    Param getMetaParam (int utype, boolean create ) throws SedException
    {
        Param param = null;
                ...
                case Utypes.SEG_CS_SPACEFRAME_EQUINOX:
                {
                    ...
                    if (coordFrames != null)
                    {
                        ...
                        for (CoordFrame coordFrame : coordFrames)
                        {
                            ...
                            {
                                if (spaceFrame != null)
                                    throw new SedException ("Multiple copies of the spaceframe found. It's ambiguous as to which param should be retrieved.");
                                else
