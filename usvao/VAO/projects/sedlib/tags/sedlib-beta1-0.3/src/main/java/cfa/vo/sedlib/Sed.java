...
//                        throw new SedInconsistentException ("The current flux axis unit, "+unit+", does not match the incoming unit, "+currUnit);
     ...
     * </ul>
     *
     * @param filename A String representing the absolute or relative path of the file to read.
