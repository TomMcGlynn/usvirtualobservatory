    ...
    extends ArrayOfGenPoint
{
    ...
    /**
     * Gets the values of the specified utype. If no data exists then
     * SedNoDataException is thrown. For points where the utype is not set
     * a default value is used; for doubles its NaN for ints its zero.
     *
     * If the utype is not supported a SedInconsistentException is thrown.
     *
...
//            throw new SedException ("There are no points to set values to.");
     ...
     *
     */
    public Field getDataInfo (String utype) throws SedInconsistentException
    {
     ...
     *
     */
    public Field getDataInfo (int utype) throws SedInconsistentException
    {

        Field dataInfo = null;
        DoubleParam dParam = null;
        IntParam iParam = null;
        ...
        for (int ii=0; ii<this.point.size (); ii++)
        {
            ...
            {
                dParam = (DoubleParam)param;
                unit = dParam.getUnit ();
            }
            else if (param instanceof IntParam)
            {
                iParam = (IntParam)param;
                unit = iParam.getUnit ();
            }

            dataInfo = new Field (param.getName (), 
                                  param.getUcd (),
                                  unit,
                                  Utypes.getName (utype));
    ...
    public void setDataInfo (Field field, int utype) throws SedNoDataException, SedInconsistentException
    {
        ...
        for (int ii=0; ii<this.point.size (); ii++)
        {
            ...
            {
                dParam = (DoubleParam)param;
                dParam.setUnit (field.getUnit ());
            }
            else if (param instanceof IntParam)
            {
                iParam = (IntParam)param;
                iParam.setUnit (field.getUnit ());
            }

             param.setName (field.getName ());
             param.setUcd (field.getUcd ());
